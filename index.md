...
|---|---|---|---|---|
| 1 | **RGAIG_PORTAL** | Vanilla HTML + CSS + JS | Framework dashboard: `index.html` + `admin.html` + `asd.html` + `architecture.html` + `survey.html` | Hosted separately (not in this committee-deliverables repo) |
