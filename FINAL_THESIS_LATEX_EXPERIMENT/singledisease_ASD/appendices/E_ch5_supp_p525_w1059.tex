...
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{4.3cm} p{8.5cm} >{\centering\arraybackslash}p{1.5cm} @{}}
...
\paragraph{Operational Workflow Stage vs.}
...
\paragraph{Five-Pillar Clinical AI Deep Audit Framework.}
...
\noindent Table~\ref{tab:doctor_patient_recommendation_kpi} presents the doctor versus patient recommendation kpi framework.
