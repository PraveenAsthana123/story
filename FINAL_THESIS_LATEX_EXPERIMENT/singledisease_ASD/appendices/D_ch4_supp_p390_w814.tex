...
\paragraph{Common Method Bias Tests.}
...
\paragraph{Primary vs. Secondary Evaluation.}
...
\paragraph{RAG Governance Layer Quality.}
...
\noindent Table~\ref{tab:fold_level_performance_1} presents the fold-level classification accuracy (\%).
...
%%--- Moved from chapter (previously suppressed) ---
\paragraph{Selected Expert Verbatim Comments.}
...
\noindent Table~\ref{tab:data_screening_summary} presents the data screening summary across all domains.
...
\noindent Table~\ref{tab:missing_data_assessment} presents the missing data assessment.
...
\noindent Table~\ref{tab:eeg_preprocessing_summary} presents the eeg preprocessing and signal quality processing summary.
...
\noindent Table~\ref{tab:freq_transform_summary} presents the frequency-domain and time-frequency transformation summary.
...
\noindent Table~\ref{tab:eeg_feature_extraction_summary} presents the eeg feature extraction and representation summary.
...
\noindent Table~\ref{tab:normalization_summary} presents the normalisation and model-input construction summary.
...
\noindent Table~\ref{tab:primary_instrument_structure} presents the primary-data instrument structure and variable summary.
...
\noindent Table~\ref{tab:eeg_evaluation_metrics} presents the eeg evaluation metrics.
...
\noindent Table~\ref{tab:eeg_hypothesis_verdict} presents the hypothesis verdict summary.
...
\paragraph{Part B Statistical and.}
