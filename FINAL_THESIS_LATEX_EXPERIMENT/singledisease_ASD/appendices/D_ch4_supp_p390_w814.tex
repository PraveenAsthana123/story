...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{\extracolsep{\fill}} p{1.0cm} p{1.0cm} p{2.3cm} p{2.1cm} p{2.0cm} p{2.9cm} p{2.2cm} @{}}
...
{\tablestripes\tablefontsize
\needspace{20\baselineskip}
\begin{xltabular}{\textwidth}{@{\extracolsep{\fill}} >{\raggedright\arraybackslash}p{3.2cm} >{\raggedright\arraybackslash}p{3.5cm} >{\raggedright\arraybackslash}p{3.1cm} >{\centering\arraybackslash}p{1.0cm} >{\raggedright\arraybackslash}p{3.0cm} @{}}
