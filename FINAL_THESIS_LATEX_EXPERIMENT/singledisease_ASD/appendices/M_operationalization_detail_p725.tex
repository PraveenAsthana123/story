...
\paragraph{B2C Service Scope for.}
...
\paragraph{Topic Proposal to Main.}
...
\paragraph{Topic Objective, Approach, Evidence.}
...
\paragraph{Professor Question Defence Matrix.}
...
\paragraph{Topic Proposal to Dissertation.}
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{1.0cm} p{9.5cm} >{\centering\arraybackslash}p{1.0cm} >{\centering\arraybackslash}p{1.0cm} @{}}
...
\noindent Table~\ref{tab:research_objectives} presents research objectives, covering O\#, Objective and Ch..

{\tablestripes\tablefontsize
\needspace{20\baselineskip}
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{1.0cm} p{9.5cm} >{\raggedright\arraybackslash}p{1.5cm} @{}}
...
\noindent Table~\ref{tab:smart_objectives} presents the smart validation of research objectives.
...
\noindent Table~\ref{tab:rq_mapping} presents research questions with linked objectives, covering RQ\#, Research Question and Linked Obj..

{\tablestripes\tablefontsize
\needspace{20\baselineskip}
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{1.0cm} p{9.5cm} >{\raggedright\arraybackslash}p{1.0cm} @{}}
...
\noindent Table~\ref{tab:problem_rq_solution} presents the problem-to-solution traceability.

\needspace{20\baselineskip}
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{1.0cm} >{\raggedright\arraybackslash}p{4.0cm} >{\raggedright\arraybackslash}p{1.0cm} p{6.9cm} >{\raggedright\arraybackslash}p{1.0cm} @{}}
...
\noindent Table~\ref{tab:non_claims} presents the what this study does not claim.
