...
\paragraph{Primary Data Collection Instruments.}
...
\noindent Table~\ref{tab:master_iv_dv} presents the master iv/dv mapping.
...
\noindent Table~\ref{tab:mixed_methods_per_disease} presents the mixed-methods research design per disease.
...
\begin{itemize}[leftmargin=*, itemsep=3pt]
    ...
    \item \textbf{Child assent} ($\geq 7$~years per ICMR National Ethical Guidelines 2017 §5.4): age-appropriate written assent for $\geq 12$~years; pictorial assent for 7--11~years; verbal assent for $<7$~years where the child can express understanding (assessed by teach-back).
    \item \textbf{DPDP Act 2023 (India) compliance:} explicit consent for processing children's personal data (DPDP Act §9: ``data fiduciary shall not undertake processing that is likely to cause any detrimental effect on the well-being of a child''); verifiable parental consent; no behavioural-tracking purposes; right to erasure honoured within 30 days of request.
