...
\noindent\textbf{Survey defensibility.} Survey instruments were developed through literature synthesis, expert review, construct mapping, and pilot evaluation. The objective was to ensure alignment between theoretical constructs and measurable survey items while maintaining content validity.
...
\paragraph{Reliability and Validity.}
...
{\tablestripes\tablefontsize
\needspace{20\baselineskip}
\begin{xltabular}{\textwidth}{@{\extracolsep{\fill}} p{1.0cm} p{7.5cm} p{1.0cm} p{1.0cm} p{1.0cm} p{1.0cm} p{1.0cm} @{}}
