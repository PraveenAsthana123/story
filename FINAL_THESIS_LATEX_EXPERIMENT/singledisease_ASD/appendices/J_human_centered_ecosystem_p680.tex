...
\noindent\textbf{Human-centered governance.} This appendix demonstrates how governance principles were translated into stakeholder-specific controls. Particular attention was given to caregiver trust, clinician oversight, accountability, transparency, and human-centered decision-making.
...
\paragraph[Unified B2B+B2C Governance]{Unified B2B+B2C Governance.}
...
\draw[arr, dashed] ([xshift=4cm]b2c.east) .. controls +(right:1.5cm) and +(right:1.5cm) .. ([xshift=4cm]b2b.east)
  node[midway, right, font=\fignodefont, align=left] {Feedback:\\caregiver concerns\\flow upward};
\end{tikzpicture}
...
{\tablestripes\tablefontsize
\needspace{20\baselineskip}
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{3.9cm} p{9.0cm} >{\centering\arraybackslash}p{1.5cm} @{}}
