...
\noindent\textbf{Operational interpretation.} The operational materials presented in this appendix are intended to illustrate practical implementation implications derived from the research findings. They should be interpreted as practitioner-oriented artifacts rather than empirical research findings.
...
{\tablestripes\tablefontsize
\needspace{20\baselineskip}
\begin{xltabular}{\textwidth}{@{} p{7.3cm} p{5.5cm} p{1.5cm} @{}}
