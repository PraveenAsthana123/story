...
\noindent Table~\ref{tab:ch4_examiner_qa_snapshot} presents examiner q\&a quick-reference --- chapter~4, covering Q\#, Anticipated question and Answer location.
...
\noindent Table~\ref{tab:headline_results} presents headline results, covering H, Claim, Key Metric, and 2 more.
...
\noindent Table~\ref{tab:ch4_parta_comprehensive} presents part a, covering Dimension Group and Part A (B2C Primary) Decision Summary.
...
\paragraph{Part A IV/DV variable specification.}
...
\noindent Table~\ref{tab:eeg_preprocessing_summary} presents eeg preprocessing and signal quality processing summary, covering Step, Method Applied, Parameters and Outcome.
...
\noindent Table~\ref{tab:ch4_partb_comprehensive} presents part b, covering Dimension Group and Part B (B2C Secondary) Decision Summary.
...
{\tablestripes\tablefontsize
\needspace{20\baselineskip}
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{3.3cm} >{\centering\arraybackslash}p{2.3cm} >{\centering\arraybackslash}p{3.9cm} >{\centering\arraybackslash}p{1.0cm} p{3.3cm} @{}}
...
\noindent Table~\ref{tab:mc_eeg_results} presents the monte carlo robustness results for secondary eeg performance.

\begin{xltabular}{\textwidth}{@{} p{1.0cm} p{1.0cm} p{2.0cm} p{2.2cm} p{2.1cm} p{3.0cm} p{2.2cm} @{}}
...
\noindent Table~\ref{tab:mc_decision_stability} presents the monte carlo-supported decision stability summary.
...
\paragraph{Mixed-Methods Convergence and Divergence Decision Logic.}
...
{\tablestripes\tablefontsize
\needspace{20\baselineskip}
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{3.2cm} p{9.5cm} >{\centering\arraybackslash}p{1.0cm} @{}}
...
\noindent Table~\ref{tab:kpi_evidence_realised} presents achieved phase-1 kpi evidence matrix --- realised values + source, covering Class, KPI, Phase-1 achieved, and 2 more.
...
Governance (Privacy)  & Encryption-coverage rate     & 100\%    & DMP audit (Ch.~3 §3.9)       & PASS \\
...
ROI                   & Hospital 3-yr NPV            & --- (deferred)  & Ch.~5 §5.4.2 NPV table & DEFERRED to Phase-2 \\
...
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{1.0cm} p{9.5cm} >{\centering\arraybackslash}p{1.0cm} >{\centering\arraybackslash}p{1.0cm} >{\centering\arraybackslash}p{1.0cm} @{}}
...
{\tablestripes\tablefontsize
\needspace{20\baselineskip}
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{1.0cm} p{7.2cm} >{\centering\arraybackslash}p{1.0cm} >{\centering\arraybackslash}p{1.0cm} >{\centering\arraybackslash}p{3.7cm} @{}}
...
{\tablestripes\tablefontsize
\needspace{20\baselineskip}
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{1.0cm} p{6.6cm} >{\centering\arraybackslash}p{1.0cm} >{\centering\arraybackslash}p{1.0cm} >{\centering\arraybackslash}p{3.2cm} >{\centering\arraybackslash}p{1.0cm} @{}}
