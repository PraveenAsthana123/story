...
\noindent\emph{Single-page thematic grouping of the 100+ dedicated-page tables added in this Ch.~3 architectural expansion. Each row identifies one theme and lists the 4--7 tables most closely related; this single matrix replaces per-page compose-footers (§49 alternative). Use this matrix to navigate clusters of related architecture / analysis / governance topics.}
...
\noindent Table~\ref{tab:thematic_xref_matrix} presents thematic cross-reference matrix, covering Theme and Related tables (4--7 per theme).
