...
\noindent Table~\ref{tab:companion_deliverables} presents companion deliverables, covering Deliverable, Purpose + audience and File + compilation.
...
\textit{Forensic substrate} & Per dissertation §51 policy: companion artefacts time-stamped + version-controlled alongside main thesis; per-iteration changelog records their addition (Table~\ref{tab:arch_iteration_changelog}). & --- \\
\end{xltabular}}
