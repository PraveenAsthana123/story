...
\begin{xltabular}{\textwidth}{@{\extracolsep{\fill}} >{\raggedright\arraybackslash}p{3.2cm} >{\raggedright\arraybackslash}p{3.9cm} p{2.5cm} >{\raggedright\arraybackslash}p{2.3cm} >{\centering\arraybackslash}p{2.0cm} @{}}
