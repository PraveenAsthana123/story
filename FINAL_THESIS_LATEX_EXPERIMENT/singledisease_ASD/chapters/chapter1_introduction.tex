...
\noindent Table~\ref{tab:ch1_object_scope} presents the research object \& scope --- in scope.
...
\noindent Table~\ref{tab:why_now} presents the why this research, why now: three converging forces.
...
\noindent Table~\ref{tab:smart_goals} presents the smart research aim.
...
\noindent Table~\ref{tab:b2c_user_forms} presents the b2c user fill-up forms.

\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{1.0cm} >{\raggedright\arraybackslash}p{3.1cm} p{7.6cm} >{\raggedright\arraybackslash}p{2.5cm} @{}}
...
{\tablestripes\tablefontsize
\needspace{20\baselineskip}
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{1.0cm} >{\raggedright\arraybackslash}p{3.1cm} p{7.6cm} >{\raggedright\arraybackslash}p{2.4cm} @{}}
...
\noindent Table~\ref{tab:continuous_monitoring} presents the continuous monitoring flow: emotiv device $$ mobile $$.

\needspace{20\baselineskip}
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{1.0cm} >{\raggedright\arraybackslash}p{2.9cm} p{7.9cm} >{\raggedright\arraybackslash}p{2.4cm} @{}}
...
\noindent Table~\ref{tab:knowledge_pipeline} presents the pipeline 3: knowledge and historical data sources for.
...
{\tablestripes\tablefontsize
\needspace{20\baselineskip}
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{1.0cm} >{\raggedright\arraybackslash}p{1.0cm} p{9.2cm} >{\raggedright\arraybackslash}p{2.9cm} @{}}
...
\noindent Table~\ref{tab:measurement_quality_summary} presents the measurement and quality assurance.
...
\noindent Table~\ref{tab:validity_assessment} presents the validity assessment.
...
\noindent Table~\ref{tab:measurement_errors} presents the measurement errors and mitigation.
...
\noindent Table~\ref{tab:analytical_purpose} presents the analytical purpose taxonomy.
...
\noindent Table~\ref{tab:theory_stats_summary} presents the theoretical integration and statistical methods.
...
\noindent Table~\ref{tab:study_scope} presents the study scope.
...
\noindent Table~\ref{tab:study_boundaries} presents the study boundaries with rationale.
...
\noindent Table~\ref{tab:alignment_statement} presents the research alignment statement.
...
{\tablestripes\tablefontsize
\needspace{20\baselineskip}
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{4.9cm} p{6.7cm} >{\centering\arraybackslash}p{2.8cm} @{}}
...
{\tablestripes\tablefontsize
\needspace{20\baselineskip}
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{4.7cm} p{8.2cm} >{\raggedright\arraybackslash}p{1.5cm} @{}}
