...
\noindent Table~\ref{tab:asis_hospital} presents as-is patient assessment in hospital settings (b2b context), covering Pain-Area Group and Current State Summary.
...
\noindent Table~\ref{tab:patient_assessment} presents patient assessment approaches in hospital (clinical + ai, covering Assessment Approach and Application in EEG/AI Context.
...
\noindent Table~\ref{tab:research_approach} presents research methodology, covering \#, Approach, Data Sources, and 2 more.
...
\noindent Table~\ref{tab:variable_taxonomy} presents variable taxonomy for rgaig framework, covering Role, Variable, Operationalisation, and 2 more.
...
\noindent Table~\ref{tab:ch1_kit_objectives} presents chapter 1 objective achievement, covering Objective, Evidence in Chapter~1 and Status.
