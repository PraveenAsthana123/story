...
\noindent Table~\ref{tab:ch1_ipo_handoff} below presents the chapter 1: Input--Process--Output Handoff; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:dba_framing} below presents the dBA Research Framing: Variables, Hypotheses, Scope; the row-level detail supports the surrounding discussion.
...
% Mediation labels (curved underneath, no extra arrows)
\node[font=\scriptsize\itshape, text=ggunavy!75] at (7.5, 1.45) {H4: Explainability mediates Governance $\to$ Trust};
\node[font=\scriptsize\itshape, text=ggunavy!75] at (12.5, 1.45) {H5: Trust mediates Explainability $\to$ Adoption};
\draw[ggunavy!50, dotted, thick] (iv.north) .. controls (3,1.8) and (7,1.8) .. (tr.north);
\draw[ggunavy!50, dotted, thick] (expl.north) .. controls (8,1.8) and (12,1.8) .. (ad.north);
\end{tikzpicture}%
}
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.7cm} >{\raggedright\arraybackslash}p{2.4cm} L >{\raggedright\arraybackslash}p{3.6cm} @{}}
...
\noindent Table~\ref{tab:ch1_kpi_targets} below presents the chapter 1 Measurable KPI Targets; the row-level detail supports the surrounding discussion.
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.8cm} >{\raggedright\arraybackslash}p{4.0cm} L @{}}
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.8cm} >{\raggedright\arraybackslash}p{4.5cm} L @{}}
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.8cm} >{\raggedright\arraybackslash}p{4.5cm} >{\raggedright\arraybackslash}p{2.5cm} L @{}}
...
\noindent Table~\ref{tab:chapter_phase_alignment} below presents the cross-Chapter Phase and Data Alignment; the row-level detail supports the surrounding discussion.

{\tablestripes\tablefontsize

\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{2.0cm} >{\raggedright\arraybackslash}p{1.6cm} >{\raggedright\arraybackslash}p{1.8cm} >{\raggedright\arraybackslash}p{2.2cm} L @{}}
...
\needspace{8\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{1.7cm} X >{\raggedright\arraybackslash}p{2.5cm} @{}}
...
\noindent Table~\ref{tab:research_positioning} below presents the research Positioning: Mapping Named Problems to RGAIG; the row-level detail supports the surrounding discussion.

{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.6cm} L L >{\raggedright\arraybackslash}p{2.6cm} >{\raggedright\arraybackslash}p{1.4cm} @{}}
...
\paragraph{Four Named Problems Motivating.}



\noindent Table~\ref{tab:problem_impact} below presents the four Named Problems Motivating This Research; the row-level detail supports the surrounding discussion.

\needspace{8\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.6cm} >{\raggedright\arraybackslash}p{3.0cm} X >{\raggedright\arraybackslash}p{3.4cm} @{}}
...
\addlinespace
Accuracy & ASD-focused consensus accuracy of 97.67\%~$\pm$~2.1\% across ASDs; PD achieves 100\% & Higher diagnostic confidence; reduced misdiagnosis and false negatives \\
\addlinespace
...
Table~\ref{tab:stakeholder_analysis} maps five stakeholder groups to the specific ways the four problems (P1--P4) affect their decisions.


\needspace{8\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{3cm} L L @{}}
...
\noindent Table~\ref{tab:as_is_to_be} below presents the aS-IS vs TO-BE Comparison; the row-level detail supports the surrounding discussion.

\needspace{8\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{2.0cm} L >{\raggedright\arraybackslash}p{2.5cm} L >{\raggedright\arraybackslash}p{2.0cm} @{}}
...
\noindent Table~\ref{tab:unified_vs_domainspecific} below presents the unified Framework vs.Domain-Specific Optimisation; the row-level detail supports the surrounding discussion.

\needspace{8\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{0.14\textwidth} >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X @{}}
...
Table~\ref{tab:problem_funnel_evidence} documents the quantitative evidence underlying each funnel layer.

\paragraph{Quantitative Evidence for Problem.}



\noindent Table~\ref{tab:problem_funnel_evidence} below presents the quantitative Evidence for Problem-to-Solution Funnel Layers; the row-level detail supports the surrounding discussion.

\needspace{8\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{2cm} L >{\raggedright\arraybackslash}p{1.8cm} >{\raggedright\arraybackslash}p{2.2cm} @{}}
...
\noindent Table~\ref{tab:b2b_subproblems} below presents the b2B Sub-Problems: Hospital and Enterprise Context; the row-level detail supports the surrounding discussion.

\needspace{12\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{1.1cm} >{\raggedright\arraybackslash}p{4.0cm} L @{}}
...
\noindent Table~\ref{tab:b2c_subproblems} below presents the b2C Sub-Problems: Consumer and Home-Monitoring Context; the row-level detail supports the surrounding discussion.
...
\paragraph{Problem and Design Mapping.}


\noindent Table~\ref{tab:problem_design_mapping} below presents the problem and Design Mapping: B2B and B2C Problem; the row-level detail supports the surrounding discussion.
...
\paragraph{Key Insight per Problem.}



\noindent Table~\ref{tab:layer_key_insights} below presents the key Insight per Problem Layer; the row-level detail supports the surrounding discussion.
...
Table~\ref{tab:asis_hospital} documents the AS-IS hospital assessment across sixteen operational dimensions.
...
\paragraph{Patient Onboarding Time Reduction.}


\noindent Table~\ref{tab:onboarding_time} below presents the patient Onboarding Time Reduction: Traditional vs.RGAIG; the row-level detail supports the surrounding discussion.

{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.6cm} >{\raggedright\arraybackslash}p{3.2cm} L L >{\raggedright\arraybackslash}p{2.0cm} @{}}
...
\noindent Table~\ref{tab:problem_decomposition} below presents the problem Decomposition: Four Business and Four Technical; the row-level detail supports the surrounding discussion.

{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.52cm} >{\centering\arraybackslash}p{0.8cm} >{\raggedright\arraybackslash}p{1.55cm} X >{\raggedright\arraybackslash}p{1.55cm} @{}}
...
Table~\ref{tab:patient_assessment} maps twenty hospital assessment approaches to their EEG-AI relevance.
...
Table~\ref{tab:b2b_psychological} catalogues psychological and organisational theories that inform clinician AI adoption and governance.
...
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{0.6cm} >{\raggedright\arraybackslash}p{2.8cm} L >{\raggedright\arraybackslash}p{2.5cm} @{}}
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{0.6cm} >{\raggedright\arraybackslash}p{3.0cm} L >{\raggedright\arraybackslash}p{2.0cm} @{}}
...
\needspace{8\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{0.6cm} >{\raggedright\arraybackslash}p{3.0cm} L >{\raggedright\arraybackslash}p{2.2cm} @{}}
...
\needspace{8\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{0.6cm} >{\raggedright\arraybackslash}p{2.8cm} L >{\raggedright\arraybackslash}p{2.0cm} @{}}
...
\needspace{8\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{0.5cm} >{\raggedright\arraybackslash}p{2.3cm} L >{\raggedright\arraybackslash}p{2cm} @{}}
...
\needspace{8\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{0.6cm} >{\raggedright\arraybackslash}p{2.8cm} L >{\raggedright\arraybackslash}p{1.5cm} @{}}
...
Table~\ref{tab:research_approach} maps the mixed-methods research design to its data sources, analysis techniques, and research objectives.


\needspace{8\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{0.6cm} >{\raggedright\arraybackslash}p{3.0cm} L L >{\raggedright\arraybackslash}p{1.5cm} @{}}
...
\paragraph{Research Gap to Research.}


\noindent Table~\ref{tab:gap_to_objective} below presents the research Gap to Research Objective Mapping; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:main_objectives} below presents the main research objectives (o1--o5); it consolidates the key elements the reader needs to engage with the subsequent discussion.


{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.8cm} L >{\centering\arraybackslash}p{1.2cm} @{}}
...
\begin{itemize}[leftmargin=*, itemsep=3pt]
    \item \textbf{Quantitative (Pipeline 1 + structured surveys):} Framework-evaluation scoring; explainability acceptance ratings (12-expert panel, $M = 4.6/5$, $\alpha = 0.84$); governance-readiness scoring; adoption-perception PLS-SEM ($n = 131$ clinicians; locked four-box causal chain: RAI governance $\to$ explainability $\to$ trust $\to$ adoption); subgroup fairness analysis (disparate impact $\geq 0.80$ gate); hallucination-rate measurement ($< 3$\% residual); retrospective ASD-EEG classification performance on KAU (97.67\% --- framed as supporting technical evidence, not the contribution claim per Chapter~\ref{chap:discussion} §Reading Guide).
...
\paragraph{Research design phases.} The study unfolds in three phases consistent with the directive: (i)~\textbf{Literature and governance analysis} (Chapter~\ref{chap:literature}: AI in ASD + XAI + RAI governance + Human-Centered AI + Adoption + HITL); (ii)~\textbf{Conceptual framework development} (Chapter~\ref{chap:methodology}: governance layer + explainability layer + HITL oversight layer + adoption-readiness layer + decision-audit schema + 6-level maturity model); (iii)~\textbf{Stakeholder evaluation and validation} (Chapter~\ref{chap:analysis}: 12-expert panel + 131-clinician PLS-SEM + retrospective benchmark + subgroup fairness + hallucination governance, all framed as governance / explainability / adoption evidence per the Reading Guide in Chapter~\ref{chap:discussion}).
...
\begin{itemize}[leftmargin=*, itemsep=3pt]
    ...
    \item \textbf{H5 (RAG-based explainability $\geq 80$\% expert agreement + $\geq 90$\% citation accuracy):} \emph{Stakeholder perception evidence for explainability acceptance}. 12-expert panel rating ($M = 4.6/5$, $\alpha = 0.84$) is directional, not population-generalisable. The finding is that experts perceive citation-grounded RAG explanations as more interpretable than score-only outputs.
\end{itemize}
...
\paragraph{Research Hypotheses with Acceptance.}



\noindent Table~\ref{tab:hypotheses} below presents the research Hypotheses with Acceptance Criteria; the row-level detail supports the surrounding discussion.
...
\iffalse % AUTO-SUPPRESS non-ASD
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{0.4cm} >{\raggedright\arraybackslash}p{2cm} L L >{\raggedright\arraybackslash}p{1.5cm} @{}}
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{0.4cm} >{\raggedright\arraybackslash}p{2cm} L L L @{}}
...
Table~\ref{tab:variable_taxonomy} presents the variable taxonomy, mapping each variable role to its operationalisation, measurement instrument, and linked hypothesis.


\needspace{8\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{1.5cm} >{\raggedright\arraybackslash}p{2cm} L L >{\raggedright\arraybackslash}p{1.2cm} @{}}
...
\needspace{8\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{2.2cm} L L L @{}}
...
Table~\ref{tab:data_collection_methods} maps the four data collection methods used in this dissertation to their purpose, instruments, and outputs.
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{0.4cm} >{\raggedright\arraybackslash}p{2.2cm} L L @{}}
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{1.8cm} L >{\raggedright\arraybackslash}p{2.2cm} >{\raggedright\arraybackslash}p{1.1cm} L @{}}
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{1.2cm} L L L L @{}}
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{1.5cm} L L >{\raggedright\arraybackslash}p{1.5cm} @{}}
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{1.5cm} >{\raggedright\arraybackslash}p{1.6cm} >{\raggedright\arraybackslash}p{1.5cm} L @{}}
...
Table~\ref{tab:research_flow_alignment} maps each business problem through literature gaps, hypotheses, and conceptual model paths to contributions.
...
\noindent Table~\ref{tab:research_flow_alignment} below presents the master Traceability Matrix; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:ch1_output_card} below presents the chapter 1 output card: deliverables to chapter 2; it consolidates the key elements the reader needs to engage with the subsequent discussion.
...
\noindent Table~\ref{tab:ch1_scorecard} below presents the chapter 1 Scorecard; the row-level detail supports the surrounding discussion.
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{4cm} L @{}}
...
Table~\ref{tab:ch1_kit_objectives} maps each research objective to the evidence and status established in this chapter.


\needspace{8\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{3.5cm} L >{\raggedright\arraybackslash}p{1.5cm} @{}}
