...
%===============================================================================
\input{chapters/chapter3_arch_executive_summary}
\input{chapters/chapter3_pipeline_dedicated_pages}
\input{chapters/chapter3_pipeline_extras}
\input{chapters/chapter3_secondary_data_pages}
\input{chapters/chapter3_iso_threshold_pages}
\input{chapters/chapter3_iso_audit_runbook}
\input{chapters/chapter3_brutal_gap_pages}
\input{chapters/chapter3_advanced_arch_pages}

\input{chapters/chapter3_crossref_index}
\input{chapters/chapter3_thematic_xref}
\input{chapters/chapter3_examiner_qa}
\input{chapters/chapter3_defence_prep_checklist}
\input{chapters/chapter3_companion_deliverables}
\input{chapters/chapter3_microservice_ipo}
\input{chapters/chapter3_arch_changelog}
...
\noindent Table~\ref{tab:ch3_mixed_methods_justification} below presents the mixed-Methods Justification; the row-level detail supports the surrounding discussion.

{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{2.6cm} L L @{}}
...
\paragraph{Sampling Plan and Sample.}


\noindent Table~\ref{tab:ch3_sampling_plan} below presents the sampling Plan and Sample-Size Justification; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:ch3_instrument_anchoring} below presents the instrument Anchoring; the row-level detail supports the surrounding discussion.

{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{3.2cm} L >{\centering\arraybackslash}p{1.4cm} @{}}
...
\noindent Table~\ref{tab:ch3_governance_ops} below presents the governance Operationalization; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:ch3_bias_mitigation} below presents the bias Mitigation Matrix; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:ch3_pilot_study} below presents the pilot Study Protocol; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:ch3_statistical_plan} below presents the statistical Analysis Plan; the row-level detail supports the surrounding discussion.

{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.6cm} >{\raggedright\arraybackslash}p{2.6cm} L >{\raggedright\arraybackslash}p{2.4cm} @{}}
...
\noindent Table~\ref{tab:ch3_construct_theory_map} below presents the construct-to-Theory Mapping; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:ch3_research_structure} below presents the research Evaluation Structure: Four Interconnected Parts; the row-level detail supports the surrounding discussion.
...
\begin{xltabular}{\textwidth}{@{} L >{\raggedright\arraybackslash}p{1cm} L >{\raggedright\arraybackslash}p{2cm} L L @{}}
...
\needspace{8\baselineskip}
\noindent Table~\ref{tab:approach_summary} summarises research Approach Summary: Quantitative, Qualitative, and Mixed Methods. The three columns capture coverage, data source, methods, and typical outputs for each research approach used in this dissertation.

{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{1.6cm} L >{\raggedright\arraybackslash}p{2.0cm} L L @{}}
...
\noindent Table~\ref{tab:combined_methodology_flow} below presents the combined Methodology Flow: Primary Data, Secondary EEG; the row-level detail supports the surrounding discussion.

{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{1.1cm} L L L >{\raggedright\arraybackslash}p{2.0cm} @{}}
...
\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.5cm} >{\raggedright\arraybackslash}p{2.6cm} L >{\raggedright\arraybackslash}p{2.2cm} @{}}
...
16 & Model Evaluation & \textbf{Input:} validated models. \textbf{Process:} accuracy; precision; recall; F1; AUC; sensitivity; specificity; confusion matrix. \textbf{Output:} performance scorecard. & Ch.~4 \S H1 97.67\% + AUC 0.956 + tab:ch4\_\allowbreak findings\_\allowbreak snapshot \\
...
\needspace{12\baselineskip}
\noindent Table~\ref{tab:five_stage_methodology} presents five-Stage Research Methodology: Gap to Decision Chain.
\noindent Table~\ref{tab:five_stage_methodology} below presents the five stage methodology; it consolidates the key elements the reader needs to engage with the subsequent discussion.

\paragraph{Five.}



\noindent Table~\ref{tab:five_stage_methodology} below presents the five-Stage Research Methodology; the row-level detail supports the surrounding discussion.

{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{0.5cm} >{\raggedright\arraybackslash}p{1.1cm} L >{\raggedright\arraybackslash}p{1.4cm} L L >{\raggedright\arraybackslash}p{1.2cm} L @{}}
...
\noindent\textbf{Five-Stage Methodology Summary: Data, Analysis, and....} Table~\ref{tab:five_stage_summary} below presents the detailed analysis.

\paragraph{Five.}


\noindent Table~\ref{tab:five_stage_summary} below presents the five-Stage Methodology Summary; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:thesis_master_table} below presents the thesis-Ready Master Table; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:primary_data_reference_catalog} below presents the catalogue of all six primary-data streams with status flags ($\bigstar$ in-scope, $\square$ future); the table consolidates instrument identifier, stream name, sample size, in-scope status, and research role per stream so the reader can quickly identify which primary-data evidence supports each H1--H10 hypothesis.

{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.8cm} >{\raggedright\arraybackslash}p{2.6cm} >{\centering\arraybackslash}p{1.2cm} >{\centering\arraybackslash}p{1.3cm} L @{}}
...
\paragraph{Primary Data Outcome Map.}


\noindent Table~\ref{tab:primary_data_outcome_map} below presents the primary Data Outcome Map; the row-level detail supports the surrounding discussion.

{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{1.0cm} L >{\centering\arraybackslash}p{1.5cm} @{}}
...
\paragraph{Secondary Data Outcome Map.}


\noindent Table~\ref{tab:secondary_data_outcome_map} below presents the secondary Data Outcome Map; the row-level detail supports the surrounding discussion.
...
SD-4 model & ASD ensemble accuracy & 97.67\% / AUC 0.956 (real) \\
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.7cm} L >{\raggedright\arraybackslash}p{2.5cm} >{\centering\arraybackslash}p{1.0cm} @{}}
...
\paragraph{Hybrid Data Outcome Map.}


\noindent Table~\ref{tab:hybrid_data_outcome_map} below presents the hybrid Data Outcome Map; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:journey_flow_map} below presents the unified Journey Flow Map; row-level detail supports the surrounding discussion.
...
5 & Model & XGBoost + CNN-LSTM ensemble (97.67\% ASD) & ML engineer (SD-4) \\
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.5cm} L >{\raggedright\arraybackslash}p{2.3cm} >{\raggedright\arraybackslash}p{2.3cm} >{\centering\arraybackslash}p{1.2cm} @{}}
...
\end{xltabular}}
\vspace{0.3em}\noindent\textit{Note.} PLS-SEM = Partial Least Squares SEM; HITL = Human-in-the-loop. See chapter prose for full context.

\noindent\textbf{Test-flow steps (7):} aggregate Likert $\to$ Cronbach $\alpha$ check $\to$ AVE/CR/HTMT validation $\to$ path coefficient bootstrap (5{,}000 resamples) $\to$ mediation/moderation tests $\to$ verdict $\checkmark$/$\sim$/$\times$ $\to$ stakeholder split (B2C/B2B).
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.6cm} >{\centering\arraybackslash}p{1.0cm} >{\centering\arraybackslash}p{0.9cm} >{\centering\arraybackslash}p{0.9cm} >{\centering\arraybackslash}p{0.9cm} >{\centering\arraybackslash}p{0.9cm} >{\centering\arraybackslash}p{0.9cm} >{\centering\arraybackslash}p{0.9cm} >{\centering\arraybackslash}p{0.9cm} @{}}
...
\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{2.6cm} >{\centering\arraybackslash}p{1.2cm} >{\centering\arraybackslash}p{1.2cm} >{\centering\arraybackslash}p{1.2cm} >{\centering\arraybackslash}p{1.6cm} >{\centering\arraybackslash}p{1.4cm} >{\centering\arraybackslash}p{1.6cm} @{}}
...
\needspace{12\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.6cm} >{\raggedright\arraybackslash}p{2.4cm} L >{\raggedright\arraybackslash}p{2.4cm} @{}}
...
\paragraph{Pediatric ASD Population Specification.}

\noindent Table~\ref{tab:primary_pediatric_population} below presents the pediatric-ASD primary-data population specification (age range, sample plan, healthy-control matching) for the prospective clinical phase; the row-level detail consolidates what was previously distributed across multiple sections so the reader can engage the population definition in a single reference.

\needspace{12\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{3.4cm} L >{\raggedright\arraybackslash}p{4.2cm} @{}}
...
\midrule
\endfirsthead
\multicolumn{3}{@{}l}{\textit{(\,Tab.~\ref{tab:primary_pediatric_population} continued from previous page\,)}} \\
\toprule
\thead{Population Attribute} & \thead{Specification} & \thead{Rationale / Source} \\
\midrule
\endhead
...
\noindent Table~\ref{tab:primary_clinical_data_items} below presents every primary clinical data item required per pediatric-ASD patient record, with field name, data type, format, and the research purpose each field informs; the inventory answers the supervisor question ``what fields do you need per patient?''.

\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{3.4cm} >{\raggedright\arraybackslash}p{2.0cm} L >{\raggedright\arraybackslash}p{2.6cm} @{}}
...
\midrule
\endfirsthead
\multicolumn{4}{@{}l}{\textit{(\,Tab.~\ref{tab:primary_clinical_data_items} continued from previous page\,)}} \\
\toprule
\thead{Field Name} & \thead{Data Type} & \thead{Format Expectation} & \thead{Research Purpose} \\
\midrule
\endhead
...
\noindent Table~\ref{tab:primary_behavioral_assessments} below presents the seven standardised behavioural-assessment instruments required as primary data, with each instrument's expected score format, date-of-administration requirement, and the H1--H7 hypotheses that depend on it; this answers the question ``which behavioural assessments are mandatory vs optional?''.

\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{2.2cm} >{\centering\arraybackslash}p{1.6cm} L >{\raggedright\arraybackslash}p{2.4cm} @{}}
...
\midrule
\endfirsthead
\multicolumn{4}{@{}l}{\textit{(\,Tab.~\ref{tab:primary_behavioral_assessments} continued from previous page\,)}} \\
\toprule
\thead{Instrument} & \thead{Status} & \thead{Score format + date-of-administration} & \thead{Informs} \\
\midrule
\endhead
...
\noindent Table~\ref{tab:primary_eeg_technical} below presents the technical specification requirements for primary EEG data, including minimum + preferred channel/rate/duration thresholds, artefact-information schema, and acquisition-protocol fields; this answers the question ``what is the minimum-viable EEG file we will accept?''.

\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{3.0cm} >{\raggedright\arraybackslash}p{3.0cm} L @{}}
...
\midrule
\endfirsthead
\multicolumn{3}{@{}l}{\textit{(\,Tab.~\ref{tab:primary_eeg_technical} continued from previous page\,)}} \\
\toprule
\thead{Specification Field} & \thead{Minimum / Preferred} & \thead{Detail / Rationale} \\
\midrule
\endhead
...
\noindent Table~\ref{tab:primary_inclusion_exclusion} below presents the explicit inclusion and exclusion criteria for the prospective pediatric-ASD primary-data cohort; criteria are stated at the patient-record level so each retrospective record can be classified ``include / exclude / partial-data'' deterministically.

\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{1.6cm} >{\raggedright\arraybackslash}p{3.6cm} L @{}}
...
\midrule
\endfirsthead
\multicolumn{3}{@{}l}{\textit{(\,Tab.~\ref{tab:primary_inclusion_exclusion} continued from previous page\,)}} \\
\toprule
\thead{Decision} & \thead{Criterion} & \thead{Rationale} \\
\midrule
\endhead
\bottomrule
\endfoot
Include & Pediatric ASD evaluation patient & Target population per §15 study population specification \\
...
\noindent Table~\ref{tab:primary_not_required_identifiers} below presents the explicit list of patient identifiers that are NOT required and MUST NOT be collected for primary-data work; the contract makes the minimum-necessary-data principle auditable by stating at field level what the dissertation does and does not need.
...
\midrule
\endfirsthead
\multicolumn{3}{@{}l}{\textit{(\,Tab.~\ref{tab:primary_not_required_identifiers} continued from previous page\,)}} \\
\toprule
\thead{Identifier} & \thead{Status} & \thead{Rationale for NOT collecting} \\
\midrule
\endhead
...
\noindent Table~\ref{tab:primary_required_documentation} below presents the institutional documentation required before any primary-data access begins; the inventory consolidates the governance prerequisites so the researcher can confirm completeness before each collaboration kicks off.
...
\midrule
\endfirsthead
\multicolumn{3}{@{}l}{\textit{(\,Tab.~\ref{tab:primary_required_documentation} continued from previous page\,)}} \\
\toprule
\thead{Document} & \thead{Status} & \thead{Purpose / Acceptance criterion} \\
\midrule
\endhead
...
\noindent Table~\ref{tab:primary_validation_support_requested} below presents the explicit clinical validation and operational-workflow support requested from collaborating institutions; the request is articulated at the workflow level so each potential collaborator can scope their contribution before committing.

\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{3.4cm} >{\raggedright\arraybackslash}p{2.6cm} L @{}}
...
\midrule
\endfirsthead
\multicolumn{3}{@{}l}{\textit{(\,Tab.~\ref{tab:primary_validation_support_requested} continued from previous page\,)}} \\
\toprule
\thead{Support Area} & \thead{Specialist Type Requested} & \thead{Requested Contribution} \\
\midrule
\endhead
...
\paragraph{Data Quality Analysis Plan.}

\noindent Table~\ref{tab:primary_analysis_data_quality} below presents the data-quality analyses performed at intake for every primary-data record; the plan defines what passes, what flags, and what triggers exclusion before any inferential analysis runs.

\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{3.0cm} >{\raggedright\arraybackslash}p{2.8cm} L >{\raggedright\arraybackslash}p{2.2cm} @{}}
...
\midrule
\endfirsthead
\multicolumn{4}{@{}l}{\textit{(\,Tab.~\ref{tab:primary_analysis_data_quality} continued from previous page\,)}} \\
\toprule
\thead{Quality dimension} & \thead{Method / test} & \thead{Acceptance threshold} & \thead{Action on failure} \\
\midrule
\endhead
...
\clearpage
\paragraph{Descriptive Statistics + Demographic Profile Plan.}

\noindent Table~\ref{tab:primary_analysis_descriptive} below presents the descriptive-statistics plan applied to the primary-data cohort; it specifies what summary statistic, what stratification, and which table or figure communicates each result so the examiner can locate the descriptive evidence per dimension.
...
\midrule
\endfirsthead
\multicolumn{4}{@{}l}{\textit{(\,Tab.~\ref{tab:primary_analysis_descriptive} continued from previous page\,)}} \\
\toprule
\thead{Dimension} & \thead{Statistic / summary} & \thead{Stratification} & \thead{Reporting artefact} \\
\midrule
\endhead
...
\noindent Table~\ref{tab:primary_analysis_preprocessing} below presents the per-step preprocessing diagnostics computed for every EEG and assessment record; the before / after plot pair per step makes each transformation auditable and aligns with the global before/after-visualisation policy.

\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.6cm} >{\raggedright\arraybackslash}p{2.6cm} L >{\raggedright\arraybackslash}p{2.6cm} @{}}
...
\midrule
\endfirsthead
\multicolumn{4}{@{}l}{\textit{(\,Tab.~\ref{tab:primary_analysis_preprocessing} continued from previous page\,)}} \\
\toprule
\thead{\#} & \thead{Preprocessing step} & \thead{Diagnostic computed} & \thead{Before / after artefact pair} \\
\midrule
\endhead
...
\end{xltabular}}
\vspace{0.3em}\noindent\textit{Note.} PSD = Power Spectral Density; ICA = Independent Component Analysis; PLV = Phase Locking Value; SD = standard deviation. Every preprocessing run saves \texttt{before\_\allowbreak <name>.png} and \texttt{after\_\allowbreak <name>.png} pairs per the global Before/After Preprocessing Visualization policy. The drill suite verifies both files exist and are valid PNGs after every pipeline run.

\clearpage
\paragraph{Reliability Analysis Plan (per Instrument + per EEG Feature).}

\noindent Table~\ref{tab:primary_analysis_reliability} below presents the reliability analyses computed per assessment instrument and per EEG-derived feature; the plan covers internal consistency, inter-rater agreement, and test-retest stability where data permits.
...
\midrule
\endfirsthead
\multicolumn{4}{@{}l}{\textit{(\,Tab.~\ref{tab:primary_analysis_reliability} continued from previous page\,)}} \\
\toprule
\thead{Reliability type} & \thead{Instrument / feature} & \thead{Method + acceptance threshold} & \thead{Reporting} \\
\midrule
\endhead
...
\clearpage
\paragraph{Convergent + Discriminant Validity Analysis Plan.}

\noindent Table~\ref{tab:primary_analysis_validity} below presents the convergent and discriminant validity analyses across instruments; the plan tests whether instruments measuring the same construct correlate (convergent) and instruments measuring distinct constructs do not (discriminant), supporting the dissertation's multi-instrument approach.
...
\midrule
\endfirsthead
\multicolumn{4}{@{}l}{\textit{(\,Tab.~\ref{tab:primary_analysis_validity} continued from previous page\,)}} \\
\toprule
\thead{Validity type} & \thead{Instrument / construct pair} & \thead{Method + threshold} & \thead{Expected} \\
\midrule
\endhead
...
\clearpage
\paragraph{EEG--Assessment Correlation Matrix Plan.}

\noindent Table~\ref{tab:primary_analysis_eeg_assessment_corr} below presents the planned EEG-feature $\times$ assessment-score correlation matrix; the matrix is the central evidence for H1 (EEG patterns correlate with ASD assessment indicators) and guides feature-selection for downstream classifiers.
...
\midrule
\endfirsthead
\multicolumn{4}{@{}l}{\textit{(\,Tab.~\ref{tab:primary_analysis_eeg_assessment_corr} continued from previous page\,)}} \\
\toprule
\thead{EEG feature family} & \thead{Specific features} & \thead{Assessment construct paired} & \thead{Test} \\
\midrule
\endhead
...
\clearpage
\paragraph{Subgroup + Fairness Analysis Plan.}

\noindent Table~\ref{tab:primary_analysis_subgroup_fairness} below presents the subgroup and fairness analyses applied to primary-data outcomes; the plan tests whether model performance and clinical interpretations hold equitably across protected attributes (sex, age, comorbidity, site).

\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{2.4cm} >{\raggedright\arraybackslash}p{3.0cm} L >{\raggedright\arraybackslash}p{2.0cm} @{}}
...
\midrule
\endfirsthead
\multicolumn{4}{@{}l}{\textit{(\,Tab.~\ref{tab:primary_analysis_subgroup_fairness} continued from previous page\,)}} \\
\toprule
\thead{Subgroup axis} & \thead{Subgroups compared} & \thead{Fairness metric + threshold} & \thead{Action on disparity} \\
\midrule
\endhead
...
\noindent Table~\ref{tab:primary_analysis_missing_data} below presents the missing-data analysis plan: pattern identification (MCAR / MAR / MNAR), per-pattern imputation strategy, and sensitivity-analysis design to test the robustness of conclusions to imputation choices.

\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{2.4cm} >{\raggedright\arraybackslash}p{3.0cm} L >{\raggedright\arraybackslash}p{2.2cm} @{}}
...
\midrule
\endfirsthead
\multicolumn{4}{@{}l}{\textit{(\,Tab.~\ref{tab:primary_analysis_missing_data} continued from previous page\,)}} \\
\toprule
\thead{Stage} & \thead{Method} & \thead{Detail + threshold} & \thead{Sensitivity check} \\
\midrule
\endhead
...
\clearpage
\paragraph{Longitudinal + Trajectory Analysis Plan.}

\noindent Table~\ref{tab:primary_analysis_longitudinal} below presents the longitudinal analyses applied to multi-visit patient records; the plan supports H7 (longitudinal AI-assisted tracking may support severe-case monitoring workflows) by formalising the visit-pair comparison + trajectory-clustering methodology.

\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{2.4cm} L >{\raggedright\arraybackslash}p{2.6cm} >{\raggedright\arraybackslash}p{2.0cm} @{}}
...
\midrule
\endfirsthead
\multicolumn{4}{@{}l}{\textit{(\,Tab.~\ref{tab:primary_analysis_longitudinal} continued from previous page\,)}} \\
\toprule
\thead{Analysis} & \thead{Method + computation} & \thead{Threshold / outcome} & \thead{Reporting} \\
\midrule
\endhead
...
\clearpage
\paragraph{Sensitivity + Bias Analysis Plan.}

\noindent Table~\ref{tab:primary_analysis_sensitivity_bias} below presents the sensitivity and bias analyses run on every primary-data result; the plan tests robustness of conclusions to data-quality thresholds, exclusion rules, and modelling choices.
...
\midrule
\endfirsthead
\multicolumn{4}{@{}l}{\textit{(\,Tab.~\ref{tab:primary_analysis_sensitivity_bias} continued from previous page\,)}} \\
\toprule
\thead{Sensitivity check} & \thead{Method} & \thead{Acceptance criterion} & \thead{Reporting} \\
\midrule
\endhead
...
\clearpage
\paragraph{Statistical Analysis Plan (SAP) per Hypothesis.}

\noindent Table~\ref{tab:primary_analysis_sap_per_hypothesis} below presents the formal Statistical Analysis Plan (SAP) per hypothesis: the specific test, effect-size measure, alpha level, power target, sample-size requirement, and multiple-comparison adjustment for each H1--H7 hypothesis. The SAP makes inferential analysis pre-specified and falsifiable.
...
\midrule
\endfirsthead
\multicolumn{4}{@{}l}{\textit{(\,Tab.~\ref{tab:primary_analysis_sap_per_hypothesis} continued from previous page\,)}} \\
\toprule
\thead{H\#} & \thead{Hypothesis (paraphrased)} & \thead{Primary test + effect size} & \thead{Power + sample-size requirement} \\
\midrule
\endhead
...
\clearpage
\paragraph{Triangulation + Quality Convergence Plan.}

\noindent Table~\ref{tab:primary_analysis_triangulation} below presents the triangulation plan that combines quantitative findings, qualitative expert judgement, and operational workflow validation into a single convergent-evidence conclusion per research question.
...
\midrule
\endfirsthead
\multicolumn{4}{@{}l}{\textit{(\,Tab.~\ref{tab:primary_analysis_triangulation} continued from previous page\,)}} \\
\toprule
\thead{Evidence type} & \thead{Source} & \thead{Convergence test} & \thead{Convergence threshold} \\
\midrule
\endhead
...
\clearpage
\input{figures/fig_instrument_score_distributions}

\clearpage
\input{figures/fig_drift_dashboard_mockup}

\clearpage
\input{figures/fig_audit_log_timeline_mockup}
...
\noindent Table~\ref{tab:research_anatomy} below presents the full anatomy chain across six dimensions per hypothesis. Each row shows: the gap from the literature, the objective that addresses the gap, the business/technical problem the objective solves, the sub-problem decomposition, the hypothesis that tests the solution, and the survey items that operationalise the hypothesis.

\needspace{16\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.5cm} >{\raggedright\arraybackslash}p{2.2cm} >{\raggedright\arraybackslash}p{2.4cm} >{\raggedright\arraybackslash}p{2.2cm} L >{\raggedright\arraybackslash}p{2.0cm} @{}}
...
\noindent Table~\ref{tab:primary_iv_dv_framework} below presents the framework support per hypothesis. Each row answers: what is the driver (IV), what is the outcome (DV), which RGAIG layer of the seven-layer architecture (Ch.~\ref{chap:discussion}) makes the variable measurable, and which SMART-E pillar (Specific / Measurable / Achievable / Relevant / Time-bound / Enterprise) makes the operationalisation defensible.

\needspace{16\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.5cm} >{\raggedright\arraybackslash}p{2.4cm} >{\raggedright\arraybackslash}p{2.4cm} >{\raggedright\arraybackslash}p{3.4cm} L @{}}
...
\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.5cm} >{\raggedright\arraybackslash}p{2.4cm} >{\raggedright\arraybackslash}p{2.4cm} >{\raggedright\arraybackslash}p{2.4cm} L @{}}
...
\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.5cm} >{\raggedright\arraybackslash}p{2.0cm} >{\raggedright\arraybackslash}p{2.4cm} L >{\raggedright\arraybackslash}p{1.8cm} @{}}
...
\noindent Table~\ref{tab:hypothesis_impact_scorecard} below presents per-hypothesis impact scores ($\bigstar$ 0--5) across overall, time, cost, onboarding, quality, support, and social-support dimensions. Each row converts the abstract hypothesis verdict into the concrete business outcome the verdict drives.

\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.5cm} >{\centering\arraybackslash}p{1.2cm} >{\centering\arraybackslash}p{1.2cm} >{\centering\arraybackslash}p{1.2cm} >{\centering\arraybackslash}p{1.4cm} >{\centering\arraybackslash}p{1.2cm} >{\centering\arraybackslash}p{1.2cm} >{\centering\arraybackslash}p{1.4cm} L @{}}
...
\bottomrule
\endlastfoot
H1 & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & \rt{\bigstar\bigstar\bigstar\bigstar\star} & \rt{\bigstar\bigstar\bigstar\bigstar\star} & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & \rt{\bigstar\bigstar\bigstar\bigstar\star} & \rt{\bigstar\bigstar\bigstar\star\star} & RAI governance maturity drives explainability foundation: faster onboarding (clear control families) + high quality (auditability) \\
H2 & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & \rt{\bigstar\bigstar\bigstar\bigstar\star} & \rt{\bigstar\bigstar\bigstar\bigstar\star} & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & \rt{\bigstar\bigstar\bigstar\bigstar\star} & Explainability $\to$ Trust: enables HITL workflow that reduces clinician time + improves support quality \\
H3 & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & \rt{\bigstar\bigstar\bigstar\bigstar\star} & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & \rt{\bigstar\bigstar\bigstar\bigstar\star} & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Trust $\to$ Adoption: enables conditional B2C deployment with B2B clinician backstop; strong social-support outcome for ASD caregivers \\
H4 & \rt{\bigstar\bigstar\bigstar\bigstar\star} & \rt{\bigstar\bigstar\bigstar\star\star} & \rt{\bigstar\bigstar\bigstar\bigstar\star} & \rt{\bigstar\bigstar\bigstar\bigstar\star} & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & \rt{\bigstar\bigstar\bigstar\bigstar\star} & \rt{\bigstar\bigstar\bigstar\star\star} & RAI $\to$ Expl $\to$ Trust mediation: justifies governance investment via trust outcome; longer time-to-validate but high quality impact \\
H5 & \rt{\bigstar\bigstar\bigstar\bigstar\star} & \rt{\bigstar\bigstar\bigstar\star\star} & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & \rt{\bigstar\bigstar\bigstar\bigstar\star} & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Expl $\to$ Trust $\to$ Adopt mediation: closes the value chain from XAI investment to caregiver/clinician adoption + family-level social support \\
H6 & \rt{\bigstar\bigstar\bigstar\star\star} & \rt{\bigstar\bigstar\bigstar\star\star} & \rt{\bigstar\bigstar\bigstar\star\star} & \rt{\bigstar\bigstar\bigstar\bigstar\star} & \rt{\bigstar\bigstar\bigstar\star\star} & \rt{\bigstar\bigstar\bigstar\bigstar\star} & \rt{\bigstar\bigstar\star\star\star} & AI-Familiarity moderator: lower business consequence (exploratory); shapes training-programme investment per clinician AI-literacy tier \\
\end{xltabular}}
\vspace{0.5em}\noindent\textit{Note.} Score legend: \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} = critical impact (drives a strategic decision); \rt{\bigstar\bigstar\bigstar\bigstar\star} = high impact; \rt{\bigstar\bigstar\bigstar\star\star} = moderate impact; \rt{\bigstar\bigstar\star\star\star} = low impact. Dimensions: \textbf{Overall} = composite business consequence; \textbf{Time} = impact on time-to-deploy (lower=\rt{\bigstar\bigstar\bigstar\bigstar\bigstar}); \textbf{Cost} = cost-reduction or cost-justification value; \textbf{Onboarding} = effect on clinician/caregiver onboarding speed; \textbf{Quality} = effect on care or model quality; \textbf{Support} = enables clinical or technical support delivery; \textbf{Social Support} = enables family-level / caregiver-network support (ASD-specific). Scores reflect the dissertation's empirical evidence + RGAIG framework alignment + SMART-E operational reach. Real PD-1 ($n{=}131$) verdicts in Ch.~\ref{chap:analysis} validate the score directionality.
...
\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.5cm} >{\raggedright\arraybackslash}p{2.2cm} >{\centering\arraybackslash}p{1.0cm} >{\centering\arraybackslash}p{1.0cm} >{\raggedright\arraybackslash}p{1.8cm} >{\centering\arraybackslash}p{1.6cm} L @{}}
...
\bottomrule
\endlastfoot
P1 & Fragmented governance for clinical AI & Business & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Hospital admin + AI ops & H1 $\to$ R1 & Ch.~5 \texttt{tab:ch5\_\allowbreak governance\_\allowbreak score} \\
P2 & Opaque AI outputs erode clinician trust & Business & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Clinicians & H2 $\to$ R3 & Ch.~4 \texttt{tab:ch4\_\allowbreak secondary\_\allowbreak xai} \\
P3 & Adoption gap: high accuracy, low clinical use & Business & \rt{\bigstar\bigstar\bigstar\bigstar\star} & Clinicians + Hospitals & H3 $\to$ R2 & Ch.~4 \S H4 94.6\% effort reduction \\
P4 & B2C deployment requires unvalidated assumptions & Business & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Caregivers + Regulators & H3 $\to$ R10 & Ch.~5 \S Conditional Deployment \\
P5 & Cross-domain validation gap (single-domain pipelines) & Technical & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & ML team + Researchers & H1 $\to$ R2 & Ch.~4 \S SD-A 97.67\% + SD-B cross-site \\
P6 & Explainability without clinical anchoring & Technical & \rt{\bigstar\bigstar\bigstar\bigstar\star} & Clinicians + AI team & H5 $\to$ R3 & Ch.~4 \S H5 RAG faithfulness \\
P7 & No regulatory mapping for clinical AI governance & Technical & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Compliance + Regulators & H4 $\to$ R7 & Ch.~5 \texttt{tab:ch5\_\allowbreak compliance\_\allowbreak score} (9 frameworks) \\
P8 & No HITL design pattern for confidence-tier routing & Technical & \rt{\bigstar\bigstar\bigstar\bigstar\star} & AI team + Clinicians & H6 $\to$ R2 & Ch.~5 \S HITL Layer + tab:ch5\_\allowbreak recommendations\_\allowbreak snapshot \\
\end{xltabular}}
\vspace{0.3em}\noindent\textit{Note.} Severity legend: \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} = critical (blocks adoption); \rt{\bigstar\bigstar\bigstar\bigstar\star} = high; \rt{\bigstar\bigstar\bigstar\star\star} = moderate. Each P-row links to (a) Hypothesis H1--H6 that tests the problem-solution path and (b) Recommendation R1--R10 in Ch.~\ref{chap:discussion} that operationalises the closure. Composes with \texttt{tab:sub\_\allowbreak problem\_\allowbreak catalog} (decomposition) and \texttt{tab:research\_\allowbreak gap\_\allowbreak catalog} (literature anchor).
...
\bottomrule
\endlastfoot
SP1.1 & P1 & No governance maturity scorecard & 6-level scale $\geq 4$ & Gov officer & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
SP1.2 & P1 & No control-family taxonomy & 7 families $\times$ 12 items & AI ops & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
SP2.1 & P2 & No SHAP attribution clarity & Clinician rating $\geq 4/5$ & XAI team & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
SP2.2 & P2 & No RAG citation traceability & 100\% citation $\to$ chunk & RAG team & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
SP3.1 & P3 & TAM-BI not measured at clinical $n$ & $n \geq 100$, BI $\geq 4/5$ & Research lead & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
SP3.2 & P3 & Workflow-fit unverified & UTAUT-FC $\geq 4/5$ & Clinical ops & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
SP4.1 & P4 & Caregiver consent process undefined & 10-stage Consensus AI & Compliance + IRB & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
SP4.2 & P4 & B2C trust pathway unanchored & 8-step pathway documented & Product + UX & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
SP5.1 & P5 & Single-domain pipelines dominate & 84\% of 156-study corpus & ML team & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
SP5.2 & P5 & Cross-site validation absent & ABIDE-II $\Delta < 5$pp & ML team & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
SP6.1 & P6 & SHAP without clinical anchor & Top-5 = biomarker-anchored & XAI team & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
SP7.1 & P7 & Regulatory $\to$ architecture mapping & 9 frameworks $\to$ 7 layers & Compliance & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
SP8.1 & P8 & Confidence-tier thresholds undefined & 3 tiers: auto/\allowbreak review/\allowbreak reject & AI ops & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
\end{xltabular}}
...
\noindent Table~\ref{tab:research_objective_catalog} below presents six numbered research objectives, each tied to a research question, hypothesis, measurable outcome, completion deadline, and priority score.

\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.5cm} L >{\raggedright\arraybackslash}p{2.0cm} >{\centering\arraybackslash}p{1.0cm} >{\raggedright\arraybackslash}p{2.0cm} >{\centering\arraybackslash}p{1.2cm} @{}}
...
\bottomrule
\endlastfoot
O1 & Operationalise RAI governance as structural antecedent of explainability & RQ1: Does governance maturity predict perceived explainability? & H1 & $\beta_{\text{RAI}\to\text{Expl}} \geq 0.20$, $p < 0.05$ & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
O2 & Demonstrate explainability predicts clinician trust beyond perceived-usefulness & RQ2: How does explainability calibrate trust? & H2 & $\beta_{\text{Expl}\to\text{Trust}} \geq 0.20$, $p < 0.05$ & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
O3 & Test trust as driver of adoption-intent + workflow-integration readiness & RQ3: Does clinician trust drive adoption? & H3 & $\beta_{\text{Trust}\to\text{Adopt}} \geq 0.20$, $p < 0.05$ & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
O4 & Test explainability as mediator of RAI $\to$ Trust & RQ4: Does explainability mediate governance to trust? & H4 & Indirect effect 95\% CI excludes 0 & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
O5 & Test trust as mediator of explainability $\to$ adoption & RQ5: Does trust mediate explainability to adoption? & H5 & Indirect effect 95\% CI excludes 0 & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
O6 & Test AI-familiarity as moderator strengthening Expl $\to$ Trust & RQ6: Does AI-familiarity moderate the trust pathway? & H6 & Interaction $|\beta_{int}| \geq 0.10$, $p < 0.10$ & \rt{\bigstar\bigstar\bigstar\star\star} \\
\end{xltabular}}
...
\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.5cm} L >{\raggedright\arraybackslash}p{2.4cm} >{\centering\arraybackslash}p{1.2cm} >{\centering\arraybackslash}p{1.4cm} >{\centering\arraybackslash}p{1.2cm} @{}}
...
\bottomrule
\endlastfoot
G1 & Governance maturity unoperationalised in clinical AI & Ch.~2 \S Gap Synthesis & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & H1 & R1 \\
G2 & TAM omits trust-calibration mechanism for opaque AI & Holzinger 2022 & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & H2 & R3 \\
G3 & Trust-in-Automation under-tested at clinical $n \geq 100$ & Lee \& See 2004 & \rt{\bigstar\bigstar\bigstar\bigstar\star} & H3 & R2 \\
G4 & Mediation governance $\to$ trust via explainability untested at clinical $n$ & Ch.~2 \S Mediation literature & \rt{\bigstar\bigstar\bigstar\bigstar\star} & H4 & R4 \\
G5 & Trust-as-mediator (Expl $\to$ Trust $\to$ Adopt) untested at clinical $n$ & Ch.~2 \S Adoption literature & \rt{\bigstar\bigstar\bigstar\bigstar\star} & H5 & R6 \\
G6 & AI-familiarity moderation rarely tested at clinical $n$ in safety-critical AI & Ch.~2 \S Moderation literature & \rt{\bigstar\bigstar\bigstar\star\star} & H6 & R7 \\
G7 & 84\% of 156-study corpus uses single-domain pipelines (cross-domain gap) & Ch.~2 \S Corpus Analysis & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & H1 + H2 & R2 \\
G8 & No regulatory $\to$ architecture mapping in published clinical AI & Ch.~2 \S Regulatory literature & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & H4 + H5 & R7 \\
G9 & No HITL confidence-tier design pattern published for ASD-EEG & Ch.~2 \S HITL literature & \rt{\bigstar\bigstar\bigstar\bigstar\star} & H6 & R2 \\
\end{xltabular}}
\vspace{0.3em}\noindent\textit{Note.} Each gap is closed by one or more named hypotheses (H1--H6) and a recommendation (R1--R10 in Ch.~\ref{chap:discussion}). Severity scores reflect: \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} = gap blocks publication / regulatory acceptance; \rt{\bigstar\bigstar\bigstar\bigstar\star} = gap weakens but does not block; \rt{\bigstar\bigstar\bigstar\star\star} = gap is exploratory / improvement opportunity. Closes with the full anatomy chain in \texttt{tab:research\_\allowbreak anatomy}.
...
\noindent Table~\ref{tab:survey_result_catalog} below presents the illustrative ($n{=}20$) survey results per construct and per hypothesis with achievement against pre-stated threshold, verdict, score, and cross-reference to the real PD-1 ($n{=}131$) value in Ch.~\ref{chap:analysis}.
...
\addlinespace
RAI Governance (IV) & $\alpha \geq 0.70$ & 0.86 & $\checkmark$ & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Ch.~4 $\alpha = 0.86$ \\
Perceived Explainability (M1) & $\alpha \geq 0.70$ & 0.83 & $\checkmark$ & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Ch.~4 $\alpha = 0.84$ \\
Clinician Trust (M2) & $\alpha \geq 0.70$ & 0.91 & $\checkmark$ & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Ch.~4 $\alpha = 0.91$ \\
Adoption Intention (DV) & $\alpha \geq 0.70$ & 0.88 & $\checkmark$ & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Ch.~4 $\alpha = 0.88$ \\
\midrule
\multicolumn{6}{@{}l}{\textit{Convergent validity (AVE)}} \\
\addlinespace
All constructs & AVE $\geq 0.50$ & 0.58--0.65 & $\checkmark$ & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Ch.~4 AVE $\geq 0.50$ all \\
\midrule
\multicolumn{6}{@{}l}{\textit{Composite reliability (CR)}} \\
\addlinespace
All constructs & CR $\geq 0.70$ & 0.87--0.93 & $\checkmark$ & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Ch.~4 CR $\geq 0.87$ all \\
\midrule
\multicolumn{6}{@{}l}{\textit{Discriminant validity (HTMT)}} \\
\addlinespace
All construct pairs & HTMT $< 0.85$ & $< 0.78$ & $\checkmark$ & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Ch.~4 HTMT $< 0.85$ all \\
\midrule
\multicolumn{6}{@{}l}{\textit{Structural path coefficients ($\beta$, bootstrap 5{,}000)}} \\
\addlinespace
H1: RAI $\to$ Expl & $|\beta| \geq 0.20$, $p < 0.05$ & $\beta = 0.62$, $p < 0.001$ & $\checkmark$ & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Ch.~4 \S H1 (real-data verdict supported) \\
H2: Expl $\to$ Trust & $|\beta| \geq 0.20$, $p < 0.05$ & $\beta = 0.71$, $p < 0.001$ & $\checkmark$ & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Ch.~4 \S H2 $\beta = 0.71$ \\
H3: Trust $\to$ Adoption & $|\beta| \geq 0.20$, $p < 0.05$ & $\beta = 0.68$, $p < 0.001$ & $\checkmark$ & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Ch.~4 \S H3 supported \\
H4: RAI $\to$ Expl $\to$ Trust & 95\% CI excludes 0 & $\beta = 0.44$, CI $[0.27, 0.59]$ & $\checkmark$ & \rt{\bigstar\bigstar\bigstar\bigstar\star} & Ch.~4 \S H4 mediation supported \\
H5: Expl $\to$ Trust $\to$ Adopt & 95\% CI excludes 0 & $\beta = 0.48$, CI $[0.31, 0.62]$ & $\checkmark$ & \rt{\bigstar\bigstar\bigstar\bigstar\star} & Ch.~4 \S H5 mediation supported \\
H6: AI-Fam $\times$ Expl $\to$ Trust & $|\beta_{int}| \geq 0.10$, $p < 0.10$ & $\beta_{int} = 0.18$, $p = 0.041$ & $\checkmark$ & \rt{\bigstar\bigstar\bigstar\star\star} & Ch.~4 \S H6 moderation supported \\
\end{xltabular}}
...
\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.5cm} L >{\centering\arraybackslash}p{1.5cm} >{\raggedright\arraybackslash}p{2.4cm} >{\raggedright\arraybackslash}p{2.0cm} >{\centering\arraybackslash}p{1.2cm} @{}}
...
\bottomrule
\endlastfoot
H1 & Governance maturity is operationalisable as 6-level scorecard & 6--12 months & Governance maturity $\geq$ Level 4 (of 6) & Audit-readiness $+$ regulatory acceptance & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
H2 & Explainable AI investment defended via trust outcome & 12--18 months & Trust-in-Automation Index $\geq 4/5$ & Clinician adoption + workflow integration & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
H3 & Trust-driven adoption reduces clinician effort 90\%+ & 18--24 months & Adoption Intent (TAM-BI) $\geq 4/5$; 94.6\% effort reduction & B2C conditional deployment + cost-out & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
H4 & RAI investment justified via mediation chain & 12--24 months & Mediation effect 95\% CI excludes 0 & Compliance acceptance ($\geq 4/5$ from 9 frameworks) & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
H5 & Explainability ROI closes via adoption pathway & 18--36 months & Mediation $\beta \geq 0.40$ + adoption $\geq 4/5$ & Caregiver trust pathway (8-step) & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
H6 & AI-familiarity training programme yields per-clinician adoption uplift & 12--18 months & Interaction $\beta_{int} \geq 0.10$; AI-Fam scale uplift & Training-programme ROI (per-clinician) & \rt{\bigstar\bigstar\bigstar\star\star} \\
\end{xltabular}}
...
\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.5cm} >{\raggedright\arraybackslash}p{2.6cm} >{\centering\arraybackslash}p{1.2cm} >{\raggedright\arraybackslash}p{2.0cm} L @{}}
...
\bottomrule
\endlastfoot
P1 & Caregiver cannot tell if AI screening is governed & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Trust loss + non-adoption & Ch.~5 \S 8-step Trust Pathway (steps 1--2) \\
P2 & Caregiver receives unexplainable AI output & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Confusion + escalation to clinician & Trust Pathway step 3 (clarity) \\
P3 & Caregiver does not adopt despite high accuracy & \rt{\bigstar\bigstar\bigstar\bigstar\star} & ASD child remains unscreened & Trust Pathway step 6 (commitment) \\
P4 & B2C deployment lacks validated caregiver-consent pathway & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Refusal / dropout at onboarding & Trust Pathway step 2 (Consensus AI) \\
P5 & Caregiver does not see cross-domain validation evidence & \rt{\bigstar\bigstar\bigstar\star\star} & Trust hesitation (not absolute block) & Trust Pathway step 4 (evidence) \\
P6 & Caregiver-friendly explanation absent (only SHAP) & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Cannot interpret screening output & Trust Pathway step 3 (plain-language) \\
P7 & Caregiver cannot verify regulatory compliance & \rt{\bigstar\bigstar\bigstar\bigstar\star} & Trust hesitation re privacy & Trust Pathway step 7 (compliance) \\
P8 & Caregiver does not know when clinician will review & \rt{\bigstar\bigstar\bigstar\bigstar\star} & Anxiety about autonomous AI & Trust Pathway step 5 (HITL transparency) \\
\end{xltabular}}
...
\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.8cm} >{\centering\arraybackslash}p{0.5cm} L >{\raggedright\arraybackslash}p{2.2cm} >{\centering\arraybackslash}p{1.0cm} @{}}
...
\bottomrule
\endlastfoot
SP1.1 & P1 & No caregiver-facing governance disclosure & ``governance'' visible in patient-facing report & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
SP2.1 & P2 & SHAP output not translated to caregiver language & Plain-language summary present? & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
SP3.1 & P3 & No caregiver-onboarding flow & Onboarding completion rate $\geq 80\%$ & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
SP4.1 & P4 & 10-stage consent process undocumented to caregiver & Consent walk-through video present? & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
SP4.2 & P4 & Withdraw / opt-out path opaque & Self-service opt-out present? & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
SP6.1 & P6 & Caregiver receives raw SHAP plot only & Plain-language wrapper present? & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
SP7.1 & P7 & Compliance attestation not visible to caregiver & Compliance summary downloadable? & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
SP8.1 & P8 & HITL review timeline opaque & ``clinician reviews within X hours'' visible? & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
\end{xltabular}}
...
\paragraph{B2C Research Objective Catalog.}
...
\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.5cm} L >{\raggedright\arraybackslash}p{2.4cm} >{\centering\arraybackslash}p{1.2cm} @{}}
...
\bottomrule
\endlastfoot
O1 & Operationalise governance so caregivers see it & ``Governance'' visible on patient-facing report; trust uplift $\geq 0.5$ on 5-point scale & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
O2 & Explainability translated to caregiver plain-language & Caregiver self-rated understanding $\geq 4/5$ & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
O3 & Caregiver adoption-intent measured + tracked & Adoption-intent $\geq 4/5$ per caregiver survey & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
O4 & Governance$\to$explainability$\to$trust mediation works for caregiver path & Caregiver mediation $\beta \geq 0.40$, CI excludes 0 & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
O5 & Caregiver-explainability$\to$trust$\to$adoption mediation works & Caregiver adoption-mediation supported & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
O6 & Caregiver-AI-literacy moderates trust pathway (training programme) & Trained-caregiver trust uplift $\geq 0.5$ vs untrained & \rt{\bigstar\bigstar\bigstar\star\star} \\
\end{xltabular}}
...
\paragraph{B2C Research Gap Catalog.}
\noindent Table~\ref{tab:b2c_research_gap_catalog} below presents the research gaps from B2C perspective with caregiver-centric severity.

\needspace{12\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.5cm} L >{\centering\arraybackslash}p{1.2cm} >{\raggedright\arraybackslash}p{2.4cm} @{}}
...
\bottomrule
\endlastfoot
G1 & No published B2C-facing governance disclosure pattern for clinical AI & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & H1 \\
G2 & TAM omits caregiver trust-calibration construct (clinician-only) & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & H2 \\
G3 & Caregiver-adoption literature thin ($n < 50$ in published studies) & \rt{\bigstar\bigstar\bigstar\bigstar\star} & H3 \\
G4 & Caregiver-side governance mediation untested in clinical AI & \rt{\bigstar\bigstar\bigstar\bigstar\star} & H4 \\
G5 & Caregiver-trust-adoption mediation untested at $n \geq 50$ & \rt{\bigstar\bigstar\bigstar\bigstar\star} & H5 \\
G6 & Caregiver AI-literacy as moderator unexamined & \rt{\bigstar\bigstar\bigstar\star\star} & H6 \\
G7 & No caregiver-facing cross-domain validation evidence visualisation & \rt{\bigstar\bigstar\bigstar\star\star} & H1+H2 \\
G8 & No caregiver-facing compliance attestation pattern & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & H4+H5 \\
G9 & No caregiver-visible HITL design pattern in published clinical AI & \rt{\bigstar\bigstar\bigstar\bigstar\star} & H6 \\
\end{xltabular}}
...
\paragraph{B2C Survey Result Catalog.}
\noindent Table~\ref{tab:b2c_survey_result_catalog} below presents the caregiver-perspective survey result interpretation per hypothesis.
...
\bottomrule
\endlastfoot
H1 (caregiver-visible governance) & Trust uplift $\geq 0.5$ & 0.62 (illustr.) & \rt{\bigstar\bigstar\bigstar\bigstar\star} & Future PD-3 ($n{=}50$ caregivers, planned) \\
H2 (caregiver explanation clarity) & Caregiver understanding $\geq 4/5$ & 4.2 (illustr.) & \rt{\bigstar\bigstar\bigstar\bigstar\star} & Future PD-3 \\
H3 (caregiver adoption-intent) & Adoption-intent $\geq 4/5$ & 4.3 (illustr.) & \rt{\bigstar\bigstar\bigstar\bigstar\star} & Future PD-3 \\
H4 (caregiver mediation chain) & 95\% CI excludes 0 & CI $[0.22, 0.51]$ (illustr.) & \rt{\bigstar\bigstar\bigstar\bigstar\star} & Future PD-3 \\
H5 (caregiver explainability mediation) & 95\% CI excludes 0 & CI $[0.26, 0.55]$ (illustr.) & \rt{\bigstar\bigstar\bigstar\bigstar\star} & Future PD-3 \\
H6 (caregiver AI-literacy moderator) & Trained-vs-untrained $\Delta \geq 0.5$ & 0.43 (illustr.) & \rt{\bigstar\bigstar\bigstar\star\star} & Future PD-3 \\
\end{xltabular}}
...
\noindent Table~\ref{tab:b2c_value_roi_kpi_impact} below presents the b2C Value/ROI/KPI/Impact Scorecard; the row-level detail supports the surrounding discussion.

\noindent Table~\ref{tab:b2c_value_roi_kpi_impact} below presents the caregiver-outcome business case per hypothesis.

\needspace{12\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.5cm} L >{\raggedright\arraybackslash}p{2.4cm} >{\raggedright\arraybackslash}p{2.0cm} >{\centering\arraybackslash}p{1.2cm} @{}}
...
\bottomrule
\endlastfoot
H1 & Caregiver sees governed AI; trust uplift via visibility & Trust uplift $\geq 0.5$ on 5-point & Caregiver onboarding success & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
H2 & Caregiver understands AI output via plain-language explanation & Understanding score $\geq 4/5$ & Family-level decision support & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
H3 & Caregiver adopts ASD screening at home & Adoption-intent $\geq 4/5$ & Early ASD intervention enabled & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
H4 & Caregiver trusts because governance + explanation work together & Mediation effect supported & Trust durability across sessions & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
H5 & Caregiver explainability investment drives adoption via trust & Mediation effect supported & Long-term screening commitment & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
H6 & Caregiver AI-literacy training programme uplifts trust + adoption & Training $\Delta \geq 0.5$ & Caregiver community network effect & \rt{\bigstar\bigstar\bigstar\star\star} \\
\end{xltabular}}
...
\bottomrule
\endlastfoot
P1 & Hospital lacks governance maturity scorecard for clinical AI procurement & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Cannot defend AI adoption to board / regulators & Ch.~5 RGAIG 6-level maturity \\
P2 & Clinician cannot audit AI output without explainability & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Workflow blockage + liability risk & Ch.~5 \S Layer 3 + Layer 6 \\
P3 & Hospital invests in AI but clinicians don't use it & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & ROI failure + sunk cost & Ch.~5 R2 ASD ensemble pilot \\
P4 & Hospital deploys B2C without clinician backstop & \rt{\bigstar\bigstar\bigstar\bigstar\star} & Regulatory + liability exposure & Ch.~5 \S B2B clinician-supported pathway \\
P5 & Cross-domain pipeline validation absent from vendor offerings & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Cannot validate vendor claims & Ch.~5 \texttt{tab:ch5\_\allowbreak compliance\_\allowbreak score} \\
P6 & Clinician receives SHAP without biomarker anchoring & \rt{\bigstar\bigstar\bigstar\bigstar\star} & Cannot integrate into clinical reasoning & Ch.~4 \S H5 biomarker-anchored SHAP \\
P7 & Hospital cannot map AI to regulatory requirements & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Cannot pass audit (SOC2, HIPAA, GDPR) & Ch.~5 \texttt{tab:ch5\_\allowbreak compliance\_\allowbreak score} (9 frameworks) \\
P8 & No HITL routing design for confidence-tier AI output & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Auto-decision risk + clinical accountability gap & Ch.~5 \S HITL Layer 5 \\
\end{xltabular}}
...
\bottomrule
\endlastfoot
SP1.1 & P1 & No 6-level governance maturity scorecard in vendor RFI & RGAIG score in vendor docs & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
SP1.2 & P1 & No 7-control-family taxonomy in procurement & 7 families documented & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
SP2.1 & P2 & SHAP not auditable end-to-end & WORM audit log per prediction & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
SP2.2 & P2 & RAG citations not version-pinned & Citation $\to$ chunk + version & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
SP3.1 & P3 & TAM-BI not measured for hospital clinicians at $n\geq 100$ & $n\geq 100$ clinicians + BI $\geq 4/5$ & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
SP3.2 & P3 & Workflow-fit not pre-validated & UTAUT-FC $\geq 4/5$ & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
SP4.1 & P4 & Clinician backstop SLA undefined & ``clinician reviews within X hours'' SLA & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
SP5.1 & P5 & Vendor offers single-domain pipeline only & Cross-site validation $\Delta < 5$pp & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
SP5.2 & P5 & Vendor lacks external validation evidence & ABIDE-II-style external benchmark & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
SP6.1 & P6 & SHAP without clinical biomarker anchoring & Top-5 features biomarker-named & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
SP7.1 & P7 & 9-framework compliance not in vendor SOC2 report & 9-framework matrix in SOC2 & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
SP8.1 & P8 & Confidence-tier thresholds vendor-undefined & 3 tiers documented (auto/\allowbreak review/\allowbreak reject) & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
\end{xltabular}}
...
\paragraph{B2B Research Objective Catalog.}
\noindent Table~\ref{tab:b2b_research_objective_catalog} below presents the B2B research objectives with clinician/hospital outcomes.
...
\bottomrule
\endlastfoot
O1 & Operationalise RAI governance as procurement scorecard & RGAIG maturity Level $\geq 4$ in vendor RFI & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
O2 & Explainability auditable end-to-end per clinical workflow & WORM audit + clinician sign-off per prediction & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
O3 & Trust drives clinician adoption at $n\geq 100$ & TAM-BI $\geq 4/5$ across $n\geq 100$ clinicians & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
O4 & Governance$\to$trust mediation defends RAI investment to board & Mediation $\beta \geq 0.40$, CI excludes 0 & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
O5 & Explainability$\to$adoption mediation drives workflow ROI & Mediation supported + 90\%+ effort reduction & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
O6 & AI-familiarity training shifts clinician adoption tier & Trained vs untrained $\Delta \geq 0.5$ on adoption & \rt{\bigstar\bigstar\bigstar\star\star} \\
\end{xltabular}}
...
\paragraph{B2B Research Gap Catalog.}
\noindent Table~\ref{tab:b2b_research_gap_catalog} below presents the research gaps from B2B perspective with clinician/hospital-centric severity.
...
\bottomrule
\endlastfoot
G1 & Governance maturity operational scorecard absent in clinical AI literature & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & H1 \\
G2 & TAM omits clinician trust-calibration construct for opaque AI & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & H2 \\
G3 & Trust-in-Automation untested at clinical $n \geq 100$ & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & H3 \\
G4 & Governance$\to$trust mediation untested at clinical $n$ & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & H4 \\
G5 & Trust$\to$adoption mediation untested at clinical $n$ & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & H5 \\
G6 & AI-familiarity moderation rarely tested in safety-critical clinical AI & \rt{\bigstar\bigstar\bigstar\bigstar\star} & H6 \\
G7 & 84\% of 156-study corpus uses single-domain pipelines & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & H1+H2 \\
G8 & No regulatory$\to$architecture mapping in published clinical AI & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & H4+H5 \\
G9 & No HITL design pattern published for ASD-EEG clinical AI & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & H6 \\
\end{xltabular}}
...
\bottomrule
\endlastfoot
H1 (RAI$\to$Expl, clinician) & $|\beta| \geq 0.20$, $p<0.05$ & $\beta = 0.62$, $p < 0.001$ & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Ch.~4 \S H1 \\
H2 (Expl$\to$Trust, clinician) & $|\beta| \geq 0.20$, $p<0.05$ & $\beta = 0.71$, $p < 0.001$ & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Ch.~4 \S H2 \\
H3 (Trust$\to$Adoption, clinician) & $|\beta| \geq 0.20$, $p<0.05$ & $\beta = 0.68$, $p < 0.001$ & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Ch.~4 \S H3 \\
H4 (RAI$\to$Expl$\to$Trust mediation) & 95\% CI excludes 0 & CI $[0.27, 0.59]$ & \rt{\bigstar\bigstar\bigstar\bigstar\star} & Ch.~4 \S H4 \\
H5 (Expl$\to$Trust$\to$Adopt mediation) & 95\% CI excludes 0 & CI $[0.31, 0.62]$ & \rt{\bigstar\bigstar\bigstar\bigstar\star} & Ch.~4 \S H5 \\
H6 (AI-Fam $\times$ Expl $\to$ Trust) & $|\beta_{int}| \geq 0.10$, $p<0.10$ & $\beta_{int} = 0.18$, $p = 0.041$ & \rt{\bigstar\bigstar\bigstar\star\star} & Ch.~4 \S H6 \\
\end{xltabular}}
...
\noindent Table~\ref{tab:b2b_value_roi_kpi_impact} below presents the b2B Value/ROI/KPI/Impact Scorecard; the row-level detail supports the surrounding discussion.

\noindent Table~\ref{tab:b2b_value_roi_kpi_impact} below presents the clinician/hospital business case per hypothesis.
...
\bottomrule
\endlastfoot
H1 & Governance maturity defends AI procurement to board & RGAIG maturity Level $\geq 4$ & Regulatory acceptance & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
H2 & Explainability + audit = liability defence & WORM audit + SHAP per prediction & Clinician workflow integration & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
H3 & Trust-driven adoption = ROI on AI investment & 94.6\% effort reduction & Hospital ROI realised & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
H4 & RAI investment justified to compliance + board & 9-framework compliance score & SOC2 + HIPAA + GDPR audit pass & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
H5 & Explainability ROI closes via clinician adoption & Adoption $\geq 4/5$ + mediation supported & Clinical decision support adoption & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
H6 & AI-familiarity training = per-clinician adoption uplift & Trained vs untrained $\Delta \geq 0.5$ & Training programme ROI & \rt{\bigstar\bigstar\bigstar\star\star} \\
\end{xltabular}}
...
\noindent\textbf{Result + assumption}: assumed all 5 architectures clear 0.85 deployment threshold; ensemble achieves 0.95/0.98 (illustrative). Reality: real KAU ($n{=}768$) ensemble achieves 97.67\% accuracy, 0.956 AUC --- consistent with this illustrative pattern.
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.6cm} >{\raggedright\arraybackslash}p{2.5cm} L >{\centering\arraybackslash}p{1.5cm} @{}}
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{2.4cm} >{\raggedright\arraybackslash}p{2.4cm} L >{\raggedright\arraybackslash}p{1.8cm} >{\centering\arraybackslash}p{1.4cm} @{}}
\caption[Expected Outputs Map]{Expected Outputs Map --- per-input $\to$ method $\to$ expected output $\to$ audience $\to$ $\bigstar$ success criterion. Outputs marked \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} are dissertation-defensible; \rt{\bigstar\bigstar\bigstar\star\star} are illustrative; \rt{\bigstar\bigstar\star\star\star} are future scope.}\label{tab:expected_outputs_map} \\
\toprule
...
PD-1 ($n{=}131$ survey) & PLS-SEM + bootstrap & H1--H5 path coefficient report; Cronbach $\alpha$/AVE/HTMT diagnostics; mediation tests & Clinician + researcher + examiner & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
PD-2 ($n{=}12$ expert panel) & 3-stage Delphi thematic coding & Theme map + representative quotes + convergence with PD-1 & Researcher + clinical governance & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
PD-3 to PD-6 (future) & Likert + interview (future) & Caregiver / educator / compliance / ASD-adult evidence & out of scope & \rt{\bigstar\bigstar\star\star\star} \\
\addlinespace
\multicolumn{5}{@{}l}{\textit{Secondary Data outputs}} \\
SD-A KAU ($n{=}768$) & XGBoost + CNN-LSTM ensemble & 97.67\% accuracy + 0.956 AUC + confusion matrix + ROC & ML engineer + clinical reviewer & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
SD-B ABIDE-II & Cross-site validation & Generalisation report + per-site fairness & ML engineer + ethics board & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
SD-3 EEG features & MNE preprocessing + spectral analysis & 127-feature catalog + feature store & ML engineer & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
SD-5 XAI & SHAP global/local + LIME + Grad-CAM & Per-prediction feature attribution + clinical interpretability report & Clinician + governance board & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
SD-6 Decision Intelligence & Rule engine + risk scoring & Risk score per case + escalation routing + recommendation report & Clinician + decision-audit log & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
SD-7 Monitoring & PSI + KSWIN drift detection & Real-time drift dashboard + alert events + MTTD report & AI Ops + governance & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
SD-8 Runtime governance & Policy engine + HITL gate & Audit lineage report + policy enforcement events + override frequency & Compliance officer + audit team & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
SD-9 Digital twin & Monte Carlo simulation & Scenario forecast + risk tornado + best/worst-case report & PMO + executive & \rt{\bigstar\bigstar\bigstar\star\star} \\
SD-10 Enterprise & SMART-E orchestration & Executive dashboard + compliance report + outcome KPI roll-up & Executive board + regulator & \rt{\bigstar\bigstar\bigstar\star\star} \\
\addlinespace
\multicolumn{5}{@{}l}{\textit{Hybrid Data outputs}} \\
H-1 to H-10 (TOP-8 $\bigstar$) & Primary $\beta$ $+$ Secondary KPI fusion & Per-phase convergence verdict + SMART-E pillar mapping & Examiner + executive + governance board & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
H-11 to H-15 (future) & --- & Ethical / Neuro-Rights / Policy Economics / Flourishing / Constitutional & future research & \rt{\bigstar\bigstar\star\star\star} \\
\addlinespace
\multicolumn{5}{@{}l}{\textit{Framework outputs}} \\
RGAIG 6-level maturity & Maturity assessment instrument (12 items) & Organisational maturity score (L1--L6) + governance investment plan & Hospital administrator + AI governance officer & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
SMART-E Operating System & Reference architecture & 7-layer architecture + runtime telemetry map + audit-row schema & Enterprise architect + CTO & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
Customer trust pathway & 8-step journey map & Caregiver onboarding playbook + trust-calibration milestones & Product owner + UX & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
Patient consent (Consensus AI) & 10-stage Consensus AI workflow & Consent record + audit row + revocation cert + erasure cert & Compliance officer + IRB & \rt{\bigstar\bigstar\bigstar\bigstar\star} \\
\addlinespace
\multicolumn{5}{@{}l}{\textit{Dissertation deliverables}} \\
Ch.~1--5 thesis & Mixed-methods design + validation & 1{,}191+ pp dissertation + appendices B--N & DBA examiner panel & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
Reference materials & MD docs + integration matrices + flow diagrams & \textsc{DATA\_FLOW\_MASTER\_REFERENCE.md} + \textsc{INTEGRATION\_ARCHITECTURE.md} + \textsc{FLOW\_DIAGRAMS.md} & Supervisor + future researcher & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} \\
\end{xltabular}}
\vspace{0.3em}\noindent\textit{Note.} PD-1 = Primary Data 1 (n=131 clinician survey); PD-2 = Primary Data 2 (n=12 expert panel); SD-A = KAU EEG (n=768); SD-B = ABIDE-II cross-site. See chapter prose for full context.
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.5cm} >{\raggedright\arraybackslash}p{2.5cm} >{\raggedright\arraybackslash}p{2.2cm} >{\raggedright\arraybackslash}p{2.6cm} L @{}}
...
\paragraph{Primary Analysis Card Success.}


\noindent Table~\ref{tab:primary_analysis_success_metrics} below presents the primary Analysis Card Success Metrics; the row-level detail supports the surrounding discussion.

{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.5cm} >{\raggedright\arraybackslash}p{2.4cm} >{\raggedright\arraybackslash}p{2.8cm} >{\centering\arraybackslash}p{1.5cm} L @{}}
...
\bottomrule
\endlastfoot
A & Response rate, missing-value rate & $\geq 80\%$ response; $\leq 5\%$ missing per item & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Re-recruit / imputation \\
B & Cronbach $\alpha$, AVE, CR, HTMT & $\alpha \geq 0.7$; AVE $\geq 0.5$; CR $\geq 0.7$; HTMT $\leq 0.85$ & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Item revision; restructure construct \\
C & Path coefficient $\beta$, $p$, $R^2$ & $|\beta| \geq 0.2$; $p < 0.05$; $R^2 \geq 0.10$ (small) & \rt{\bigstar\bigstar\bigstar\bigstar\star} & Re-specify model; check measurement \\
D & Sobel $z$, interaction $f^2$ & Sobel $z > 1.96$; $f^2 \geq 0.02$ & \rt{\bigstar\bigstar\bigstar\bigstar\star} & Report null mediation/moderation \\
E & Inter-coder agreement, theme saturation & $\kappa \geq 0.7$; theme saturation across 3 stages & \rt{\bigstar\bigstar\bigstar\bigstar\bigstar} & Add coder; expand interview pool \\
\end{xltabular}}
...
\noindent Table~\ref{tab:secondary_analysis_cards} below presents the six secondary-data analysis cards (Cards A through F), each tabulating stage, method, expected output, and concrete analysis tasks; cards proceed sequentially from EEG preprocessing (Card A) through runtime monitoring (Card F).

{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.5cm} >{\raggedright\arraybackslash}p{2.3cm} >{\raggedright\arraybackslash}p{2.2cm} >{\raggedright\arraybackslash}p{2.5cm} L @{}}
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.5cm} >{\raggedright\arraybackslash}p{2.5cm} >{\raggedright\arraybackslash}p{2.3cm} >{\raggedright\arraybackslash}p{2.5cm} L @{}}
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.7cm} L >{\raggedright\arraybackslash}p{2.5cm} >{\centering\arraybackslash}p{0.7cm} >{\centering\arraybackslash}p{0.7cm} @{}}
...
\noindent Table~\ref{tab:ch3_analysis_methods_xstream} below presents the analysis Methods Applied --- Primary / Secondary / Hybrid; the row-level detail supports the surrounding discussion.
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{3.2cm} >{\centering\arraybackslash}p{1.6cm} >{\centering\arraybackslash}p{1.6cm} L @{}}
...
\needspace{12\baselineskip}
\noindent\textbf{Monte Carlo use-case map.} Where Monte Carlo simulation applies across the three streams (Phase~2 §2.8 + Phase~4 §4.11 + Phase~10 §10.10 sources).

\paragraph{Monte Carlo Use.}


\noindent Table~\ref{tab:ch3_monte_carlo_uses} below presents the monte Carlo Use-Case Map --- Primary / Secondary / Hybrid; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:ch3_todo_status_xstream} below presents the tODO / Status Map --- Primary / Secondary / Hybrid; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:ch3_chapter_summary_xstream} below presents the chapter Summary Matrix --- Primary / Secondary / Hybrid; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:b2c_b2b_assessment_crosswalk} below presents the crosswalk between every clinical assessment instrument referenced by the framework, the audience track (B2C caregiver vs B2B clinician) that captures it, the lifecycle stage informed, the framework's role with respect to each instrument, and an explicit authority boundary; the boundary column makes explicit that the framework never administers diagnostic instruments autonomously.

{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{2.6cm} >{\raggedright\arraybackslash}p{1.4cm} >{\raggedright\arraybackslash}p{2.2cm} L >{\raggedright\arraybackslash}p{2.4cm} @{}}
...
\noindent Table~\ref{tab:scale_design} below presents the questionnaire Scale Design; the row-level detail supports the surrounding discussion.

\needspace{8\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{1.8cm} L >{\raggedright\arraybackslash}p{0.9cm} @{}}
...
\paragraph{Primary and Secondary Data.}


\noindent Table~\ref{tab:primary_secondary_data} below presents the primary and Secondary Data Sources and Their Roles; the row-level detail supports the surrounding discussion.

\needspace{8\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{1.5cm} >{\raggedright\arraybackslash}p{2.4cm} L L >{\raggedright\arraybackslash}p{2.0cm} @{}}
...
\paragraph{Secondary EEG Data.}


\noindent Table~\ref{tab:eeg_master_logic} below presents the secondary EEG Data; the row-level detail supports the surrounding discussion.

\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{1.6cm} >{\raggedright\arraybackslash}p{1.4cm} L >{\raggedright\arraybackslash}p{1.5cm} L >{\raggedright\arraybackslash}p{1.4cm} L @{}}
...
\noindent Table~\ref{tab:eeg_variables} below presents the secondary EEG Data; the row-level detail supports the surrounding discussion.
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{0.6cm} >{\raggedright\arraybackslash}p{3.8cm} L @{}}
...
\noindent Table~\ref{tab:eeg_e2e_logic} below presents the eEG End-to-End Pipeline; the row-level detail supports the surrounding discussion.
...
\begin{itemize}[leftmargin=*, itemsep=2pt]
    ...
    \item \textbf{Stream 3: 131-clinician PLS-SEM (prior IRB-approved aggregated anonymised secondary data).} Prior IRB approval reference: \texttt{[PRIOR IRB APPROVAL --- DATE + NUMBER + INSTITUTION TO INSERT BEFORE SUBMISSION]}. Original primary collection was conducted under separate prior IRB approval; the current dissertation uses only aggregated anonymised data from that prior study and does NOT recruit any new clinicians.
    \item \textbf{Stream 4: 12-expert qualitative panel (prior IRB-approved aggregated anonymised secondary data).} Prior IRB approval reference: \texttt{[PRIOR IRB APPROVAL --- DATE + NUMBER + INSTITUTION TO INSERT BEFORE SUBMISSION]}. Same prior-IRB scope as Stream 3.
\end{itemize}
...
\noindent Table~\ref{tab:data_needs_by_stage_audience} below presents the data and Assessment Needs by Stage and Audience; the row-level detail supports the surrounding discussion.

\needspace{16\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{2.2cm} >{\raggedright\arraybackslash}p{1.2cm} L L L @{}}
...
\needspace{10\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{4.5cm} >{\raggedright\arraybackslash}p{2.0cm} L >{\raggedright\arraybackslash}p{2.5cm} @{}}
...
\needspace{10\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{3.5cm} L L >{\raggedright\arraybackslash}p{2.5cm} @{}}
...
\needspace{8\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{3.2cm} L L L @{}}
...
\bottomrule
\endlastfoot
Screening accuracy (technical layer) & Single-domain ASD-EEG classifiers 78--92\% & Ensemble framework 97.67\% on retrospective KAU & Retrospective benchmark; prospective pilot pending \\
\addlinespace
...
\needspace{8\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{2.8cm} L L >{\raggedright\arraybackslash}p{2.2cm} @{}}
...
\needspace{8\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{2.5cm} L L L >{\raggedright\arraybackslash}p{2.0cm} @{}}
...
\addlinespace
Privacy & PHI / personal data; cross-border-transfer requests & De-identification; encryption at rest + in transit; access control; data-minimisation & Privacy audit report; access-review report; data-flow diagram & HIPAA §164.312; GDPR Art.~5+6; DPDP \\
\addlinespace
...
\needspace{8\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{2.4cm} L L L >{\raggedright\arraybackslash}p{2.2cm} @{}}
...
\addlinespace
\textbf{Privacy control} (B2C + B2B) & Caregiver consent + data subject preferences & De-identification + access control + audit + cross-border-transfer evaluation & Privacy-status dashboard for caregiver; compliance audit for B2B & NIST AI RMF GV-1; ISO/IEC 42001 §7.4; HIPAA §164.312; GDPR; DPDP \\
\addlinespace
...
\addlinespace
\textbf{Audit transparency} (B2B + Audit) & Per-decision audit row & Immutable Postgres + S3 WAL; 7-year retention; per-decision traceability & Audit-trail report; compliance evidence package & ISO/IEC 42001 §9.1; SOC 2 CC7.2, CC7.3; HIPAA §164.312 \\
\addlinespace
...
\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{2.0cm} L L >{\raggedright\arraybackslash}p{2.0cm} >{\raggedright\arraybackslash}p{2.0cm} L @{}}
...
\needspace{10\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{2.8cm} >{\raggedright\arraybackslash}p{2.2cm} >{\raggedright\arraybackslash}p{2.2cm} >{\raggedright\arraybackslash}p{2.0cm} L @{}}
...
\noindent\textbf{Examiner reading map.} Each AI dimension's full coverage is accessible via four anchor points: (i)~\textbf{conceptual introduction} in Chapter~\ref{chap:introduction} or Chapter~\ref{chap:literature} (Lit Review Lens Map); (ii)~\textbf{methodological specification} here in Chapter~\ref{chap:methodology} (Parts 5--13); (iii)~\textbf{empirical evidence} in Chapter~\ref{chap:analysis} (Findings Lens Map); (iv)~\textbf{managerial discussion} in Chapter~\ref{chap:discussion} (Findings Lens Map + Management Analysis Decision Matrix). The cross-chapter linkage ensures that the AI-solution view is continuous: a reader who starts with a single dimension can trace it through the entire dissertation without re-orienting.
...
\begin{tikzpicture}[
    ...
    arr/.style={-{Stealth[length=2.5mm, width=2mm]}, line width=0.7pt, ggunavy},
]
% INPUT column (left)
...
\noindent Table~\ref{tab:ch3_partb_smart} below presents the part b: smart and rgaig framework alignment; it consolidates the key elements the reader needs to engage with the subsequent discussion.
...
\noindent Table~\ref{tab:ch3_partb_ipo} below presents the part B: Input--Process--Output--Boundary Specification; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:ch3_partb_bootstrap} below presents the part B: Bootstrap Resampling Strategy for EEG; the row-level detail supports the surrounding discussion.

{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{2.8cm} L L >{\raggedright\arraybackslash}p{2.5cm} @{}}
...
\node[outcome] (find) at (0,-14.5) {\textbf{Findings}\\ASD 97.67\%\\CI [95.2, 99.4]};
...
\noindent Table~\ref{tab:ch3_parta_smart} below presents the part a: smart and rgaig framework alignment; it consolidates the key elements the reader needs to engage with the subsequent discussion.
...
\noindent Table~\ref{tab:ch3_parta_ipo} below presents the part A: Input--Process--Output--Boundary Specification; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:ch3_parta_bootstrap} below presents the part A: Bootstrap Resampling Strategy for Survey Data; the row-level detail supports the surrounding discussion.
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{1.2cm} >{\raggedright\arraybackslash}p{0.8cm} >{\raggedright\arraybackslash}p{1.6cm} >{\raggedright\arraybackslash}p{1.8cm} >{\raggedright\arraybackslash}p{0.8cm} L @{}}
...
\needspace{8\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{0.6cm} >{\raggedright\arraybackslash}p{4cm} L @{}}
...
\noindent Table~\ref{tab:primary_hypothesis_decision} below presents the primary-Data Hypothesis and Decision Logic; the row-level detail supports the surrounding discussion.
...
Part~C addresses the B2B hospital evaluation context using a \textbf{qualitative-only approach}. Part~C does \textbf{not} have its own EEG pipeline or quantitative classification analysis. The ASD classification accuracy (97.67\%), SHAP rankings, and RAG scores produced by Part~B (B2C Quantitative) are consumed as \textit{given evidence}---they are the input that clinicians evaluate, not data that Part~C re-analyses.
...
\noindent Table~\ref{tab:ch3_partc_qual} below presents the part C: B2B Hospital Qualitative Analysis --- Clinician; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:ch3_partc_smart} below presents the part c: smart and rgaig framework alignment; it consolidates the key elements the reader needs to engage with the subsequent discussion.

\paragraph{Part C.}



\noindent Table~\ref{tab:ch3_partc_smart} below presents the part C: SMART and RGAIG Framework Alignment; the row-level detail supports the surrounding discussion.
...
\bottomrule
\endlastfoot
\textbf{SMART} & Specific: deploy ASD ensemble in hospital with 14-ch EEG + HL7 FHIR + clinician trust $\geq 3.5/5$ + turnaround $\leq 30$ min. Measurable: accuracy, AUC, latency, turnaround, trust score, $\Delta$ pre--post, ROI, TCO. Achievable: Part~B pipeline validated at 97.67\%; $n \geq 30$ clinicians recruitable. Relevant: B2C accuracy must validate in hospital HITL. Time-bound: Q1--Q2 2026 pilot. \\
\addlinespace
...
\noindent Table~\ref{tab:ch3_partc_ipo} below presents the part C: Input--Process--Output--Boundary Specification; the row-level detail supports the surrounding discussion.
...
\addlinespace
\textbf{Input from Part B} & ASD classification accuracy (97.67\%), AUC, SHAP rankings, RAG quality scores, ablation results, computational cost, automation time savings \\
\addlinespace
...
\noindent Table~\ref{tab:ch3_partc_bootstrap} below presents the part C: Bootstrap Resampling Strategy for B2B Integrated; the row-level detail supports the surrounding discussion.
...
\node[pipenode, fill=lightorange] (pb) at (6,0) {\textbf{Part B Output}\\ASD 97.67\%,\\SHAP, RAG scores};
...
\iffalse % AUTO-SUPPRESS non-ASD
\needspace{10\baselineskip}
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{1.3cm} >{\raggedright\arraybackslash}p{2.5cm} L >{\raggedright\arraybackslash}p{1.8cm} @{}}
...
\paragraph{Objective to Hypothesis and.}


\noindent Table~\ref{tab:objective_hypothesis_variable} below presents the objective to Hypothesis and Variable Mapping; the row-level detail supports the surrounding discussion.
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{0.7cm} >{\raggedright\arraybackslash}p{2.3cm} L >{\raggedright\arraybackslash}p{2.1cm} >{\raggedright\arraybackslash}p{1.3cm} @{}}
...
\noindent Table~\ref{tab:research_strands} below presents the research Strands; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:ch3_methodology_approach} below presents the chapter 3 Methodology Approach; the row-level detail supports the surrounding discussion.
...
\clearpage
\paragraph{Integrated SEM Path Model.}

\needspace{8\baselineskip}
\noindent Table~\ref{tab:ch3_sem_model} below presents the integrated Structural Equation Model (SEM) path model showing hypothesised causal relationships among latent constructs (Explainability, Usability, Trust, Adoption, Evaluation Decision); the table consolidates path coefficients, hypothesis labels, and the qualitative direction for each relationship the reader needs to engage with the subsequent discussion.
...
Monte Carlo simulation with 10,000 iterations is conducted to assess the robustness of model accuracy, trust scores, and adoption outcomes under varying conditions. Unlike bootstrap (which resamples observed data), Monte Carlo \textbf{generates synthetic scenarios} by perturbing input parameters within their observed distributions, testing whether the system maintains stable performance across variability.
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.5cm} >{\raggedright\arraybackslash}p{2.5cm} L >{\centering\arraybackslash}p{1.5cm} >{\centering\arraybackslash}p{1.5cm} @{}}
...
\noindent Table~\ref{tab:hypothesis_mapping} below presents the hypothesis Mapping: Objective Links, Variables; the row-level detail supports the surrounding discussion.

{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{2.5cm} >{\raggedright\arraybackslash}p{1.2cm} L >{\raggedright\arraybackslash}p{1.8cm} >{\raggedright\arraybackslash}p{1.5cm} @{}}
...
Table~\ref{tab:10phase_master} documents the master configuration for each phase, specifying objectives, key methods, and expected outputs.

\paragraph{Ten.}


\noindent Table~\ref{tab:10phase_master} below presents the ten-Phase Framework Master Configuration; the row-level detail supports the surrounding discussion.

\needspace{14\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{0.7cm} >{\raggedright\arraybackslash}p{2.3cm} L >{\raggedright\arraybackslash}p{3.4cm} >{\raggedright\arraybackslash}p{3.2cm} @{}}
...
\paragraph{Monte Carlo Stability Interpretation.}


\noindent Table~\ref{tab:monte_carlo_thresholds} below presents the monte Carlo Stability Interpretation: Threshold Guidance; the row-level detail supports the surrounding discussion.
...
\paragraph{Monte Carlo Applicability Across.}


\noindent Table~\ref{tab:monte_carlo_applicability} below presents the monte Carlo Applicability Across Data Strands; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:top20_techniques} evaluates top-20 Priority Technique Stack for Thesis Evaluation.
\noindent Table~\ref{tab:top20_techniques} below presents the top20 techniques; it consolidates the key elements the reader needs to engage with the subsequent discussion.

\paragraph{Top.}



\noindent Table~\ref{tab:top20_techniques} below presents the top-20 Priority Technique Stack for Thesis Evaluation; the row-level detail supports the surrounding discussion.

\begin{xltabular}{\textwidth}{@{} r >{\raggedright\arraybackslash}p{2.5cm} L L >{\raggedright\arraybackslash}p{1cm} @{}}
...
\noindent Table~\ref{tab:technique_chapter_placement} below presents the technique Placement Across Thesis Chapters; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:technique_value_matrix} below presents the technique Value Matrix: Adoption, Trust, Responsibility; the row-level detail supports the surrounding discussion.
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{0.7cm} >{\raggedright\arraybackslash}p{2.6cm} >{\raggedright\arraybackslash}p{1.4cm} L >{\raggedright\arraybackslash}p{1.4cm} >{\raggedright\arraybackslash}p{1.7cm} @{}}
...
%% Contains result values (97.67% ASD ensemble, AUC=0.956, Krippendorff's alpha=0.84,
...
\noindent Table~\ref{tab:ch3_partd_bootstrap} below presents the part D: Master Bootstrap Resampling Protocol ---; the row-level detail supports the surrounding discussion.
...
\needspace{18\baselineskip}
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\bfseries}p{3.6cm} L >{\raggedright\arraybackslash}p{2.4cm} @{}}
