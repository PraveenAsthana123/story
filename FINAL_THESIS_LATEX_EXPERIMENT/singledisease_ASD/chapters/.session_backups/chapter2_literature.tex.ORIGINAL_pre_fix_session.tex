...
\noindent Table~\ref{tab:ch2_ipo_handoff} below presents the ch2 ipo handoff; it consolidates the key elements the reader needs to engage with the subsequent discussion.
...
\noindent Table~\ref{tab:lit_contradictions} below presents the contradictions in Existing Healthcare AI Literature; the row-level detail supports the surrounding discussion.

{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{3.6cm} L >{\raggedright\arraybackslash}p{2.6cm} @{}}
...
\paragraph{Limitations of Existing Studies.}


\noindent Table~\ref{tab:lit_limitations} below presents the limitations of Existing Studies by Theme; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:synth_clinical_conditions} below presents the synthesis: five clinical conditions; it consolidates the key elements the reader needs to engage with the subsequent discussion.

\paragraph{Synthesis.}



\noindent Table~\ref{tab:synth_clinical_conditions} below presents the synthesis: Five Clinical Conditions; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:synth_eeg_diagnostics} below presents the synthesis: EEG-Based Diagnostics; the row-level detail supports the surrounding discussion.
...
Four B2C-relevant gaps remain open and define the empirical contribution scope of this dissertation. (i)~No published study calibrates a six-construct caregiver trust model (understandable result + confidence score + doctor confirmation + privacy control + no autonomous diagnosis + clear next step); existing measures collapse trust to a single Likert item. (ii)~No published study contrasts a clinician explainability layer (SHAP + EEG features) against a caregiver layer (plain-language) for the \emph{same underlying AI output}; the consistency invariant has not been tested. (iii)~No published study measures the seven-axis B2C readiness score (trust, usability, affordability, comfort, privacy, clinician-sharing, SOS consent) on prospective ASD families. (iv)~No published study compares Canadian vs.\ Indian B2C adoption gates for a paediatric-screening wearable; the regulatory + affordability differential is qualitatively understood but not measured.
...
\noindent Table~\ref{tab:synth_xai_rag} below presents the synthesis: Explainable AI and RAG; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:synth_cross_dataset} below presents the synthesis: Cross-Dataset Generalization and Ensemble; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:synth_responsible_ai} below presents the synthesis: Responsible AI Frameworks in Clinical; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:synth_pipeline_automation} below presents the synthesis: Automated Pipeline and Multi-Agent Systems; the row-level detail supports the surrounding discussion.
...
\noindent Table~\ref{tab:synth_cross_domain} below presents the synthesis: ASD-Focused Unification; the row-level detail supports the surrounding discussion.
...
Four decision criteria emerged from the thematic synthesis, derived from the intersection of performance baselines (Table~\ref{tab:key_studies}), healthcare economics benchmarks, and regulatory timelines: (1)~diagnostic accuracy $\geq$85\% across $\geq$4 domains; (2)~ROI $\geq$200\% over 3~years; (3)~time-to-market $\leq$18 months; and (4)~documented regulatory submission strategy.
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\raggedright\arraybackslash}p{0.6cm} >{\raggedright\arraybackslash}p{2.0cm} L L @{}}
...
% Part B
\node[box=lightorange] (b) at (0,4) {\textbf{Part B: Technical}\\ASD Accuracy 97.67\%\\SHAP + RAG};
% Explainability
...
\noindent Table~\ref{tab:lit_synthesis_consolidated} below presents the consolidated Literature Synthesis: Gaps and Study Design; the row-level detail supports the surrounding discussion.

{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{}>{\raggedright\arraybackslash}p{2.2cm} X X@{}}
...
{\tablestripes\tablefontsize
\begin{xltabular}{\textwidth}{@{} >{\bfseries}p{2.8cm} L L L @{}}
...
\noindent Table~\ref{tab:ch2_scorecard} below presents the chapter 2 Scorecard; the row-level detail supports the surrounding discussion.
