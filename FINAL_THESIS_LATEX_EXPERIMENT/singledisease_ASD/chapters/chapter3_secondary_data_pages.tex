...
\clearpage
\paragraph[Secondary Data AS-IS Process]{Secondary Data AS-IS Process --- Current Acquisition + Curation Workflow.}
...
\clearpage
\paragraph[Secondary Data Challenges]{Secondary Data Challenges --- Friction Inventory for Current Workflow.}
...
\clearpage
\paragraph[Secondary Data Sample]{Secondary Data Sample --- 10 KAU-Style Records (Feature Vectors).}
...
\clearpage
\paragraph[Secondary Data Phase Conversion]{Secondary Data Phase-Based Conversion Flow.}
...
\clearpage
\paragraph[Secondary Data Journey Lifecycle]{Secondary Data Journey Lifecycle --- Discovery to Sunset.}
...
\clearpage
\paragraph[Secondary Data Models]{Secondary Data Models --- Per-Model Application Summary.}
...
\clearpage
\paragraph[Secondary Data Accuracy]{Secondary Data Accuracy --- Per-Model Per-Cohort Results.}
...
\clearpage
\paragraph[Secondary Data RGAIG Application]{Secondary Data RGAIG Framework Application --- Per-Layer Mapping.}
...
\clearpage
\paragraph[Secondary Data SMART Framework]{Secondary Data SMART(-E) Framework Application.}
...
\clearpage
\paragraph[Secondary Data Analysis Flow]{Secondary Data Analysis Flow --- Ordered List of Analyses.}
...
\clearpage
\paragraph[Secondary Data TO-BE Solution]{Secondary Data TO-BE Solution --- Emotiv + Cloud + Mobile App.}
...
\clearpage
\paragraph[Secondary Data AS-IS Reports]{Secondary Data AS-IS Reports --- List of Reports Generated Today.}
...
\clearpage
\paragraph[Channels: 10-20 System]{10--20 EEG Channel System --- Standard Channel Inventory.}
...
\clearpage
\paragraph[Brain Regions]{Brain Regions Relevant to ASD-EEG Analysis.}
...
\clearpage
\paragraph[Wavelength / Frequency Healthy vs ASD]{EEG Frequency Bands and Wavelengths --- Healthy vs ASD-Affected Patterns.}


\noindent This table lists each \textit{band} across frequency (hz), wavelength, healthy typical, and 1 more dimensions, so examiners can trace what was assessed and what evidence supports each row.
...
\clearpage
\paragraph[Severity Tiers DSM-5]{ASD Severity Tiers --- Low / Medium / High (DSM-5 Level 1 / 2 / 3).}


\noindent This table lists each \textit{tier} across support level, social-comm impact, rrb impact, and 1 more dimensions, so examiners can trace what was assessed and what evidence supports each row.
...
\clearpage
\paragraph[Impact Social School Home Activity]{ASD Impact Per Life Domain --- Social, School, Home, Activity, Family.}
...
\clearpage
\paragraph[Phase Card Flow]{Secondary Data Phase Card Flow --- Per-Phase Card.}
...
\clearpage
\paragraph[Per-Phase Deep Dive]{Per-Phase Deep Dive --- Input/Process/Output/Tool/Quality/Security/Benchmark/Monitor.}
...
\clearpage
\paragraph[AI Dimensions per Phase]{AI Dimensions Per Phase --- XAI / RAI / Ethical / Governance / Trust / Bias / Interpretable / Debug AI.}
...
\clearpage
\paragraph[KPI per Phase]{KPI Per Phase --- Monitoring AI / Score AI / Quality AI / Trust AI.}


\noindent This table lists each \textit{phase} across monitoring ai kpi, score ai kpi, quality ai kpi, and 1 more dimensions, so examiners can trace what was assessed and what evidence supports each row.
