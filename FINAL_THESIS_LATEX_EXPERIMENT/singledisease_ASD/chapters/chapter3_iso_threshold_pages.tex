...
\clearpage
\paragraph[Per-Phase Library + How-to-Achieve]{Per-Phase Library + Tool +.}


\noindent This table lists each \textit{phase} across primary library, xai achieve, rai achieve, and 1 more dimension, so examiners can trace what was assessed and what evidence supports each row.
...
\noindent Table~\ref{tab:per_phase_library_kpi} presents per-phase library + how-to-achieve, covering Phase, Primary library, XAI achieve, and 2 more.
...
\clearpage
\paragraph[Per-Phase Input Process Output Benchmark Threshold]{Per-Phase Input + Process +.}
...
\noindent Table~\ref{tab:per_phase_ipo_benchmark} presents per-phase input process output benchmark threshold, covering Phase, Input, Process, and 3 more.
...
\clearpage
\paragraph[Per-Phase ISO 42001 + Healthcare ISO Mapping]{Per-Phase ISO 42001 + Healthcare.}


\noindent This table lists each \textit{phase} across iso 42001 clause, healthcare iso, risk class, and 1 more dimension, so examiners can trace what was assessed and what evidence supports each row.
...
\noindent Table~\ref{tab:per_phase_iso_42001} presents per-phase iso 42001 + healthcare iso mapping, covering Phase, ISO 42001 clause, Healthcare ISO, and 2 more.
