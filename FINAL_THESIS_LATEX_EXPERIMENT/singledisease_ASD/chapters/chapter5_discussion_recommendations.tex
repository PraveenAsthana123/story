...
\noindent Table~\ref{tab:ch5_future_work_roadmap} presents future work roadmap, covering F\#, Future research direction, Dependency, and 2 more.
...
\noindent Table~\ref{tab:ch5_final_defence_checklist} presents final defence checklist, covering \#, Defence item, Section pointer and $\bigstar$.
...
\paragraph{Rgaig Vs Peer Governance Frameworks.}
\needspace{20\baselineskip}
...
\noindent Table~\ref{tab:workflow_value} presents workflow and operational value summary, covering Indicator, Evidence, Status and Operational Verdict.
...
\noindent Table~\ref{tab:consent_protocol} presents the patient consent and data subject rights protocol.
...
\noindent Table~\ref{tab:ch5_partd_combined_verdict} presents part d, covering Pathway, H1--H3, H4--H5, and 3 more.
...
\noindent Table~\ref{tab:evidence_framework} presents the three-level evidence framework for evaluation readiness.
...
\noindent Table~\ref{tab:stakeholder_value_cards} presents stakeholder value cards --- pain, covering Stakeholder, Pain today, Value delivered (Phase-1 evidence), and 2 more.
...
\paragraph{Hospital 3-year NPV model.}
...
\noindent Table~\ref{tab:hospital_npv_phase2} presents hospital 3-year npv model (phase-2 placeholder), covering Line item, Year 1, Year 2, and 2 more.
...
\noindent Table~\ref{tab:secondary_data_stack} presents secondary data execution stack (sd-1 to sd-10), covering Stage, Phase Title and Owning Chapter.
...
\noindent Table~\ref{tab:ch5_compliance_score} presents compliance scoring matrix ($\bigstar$ 0--5), covering Framework, Score, Evidence anchor and Gap to $\bigstar$$\bigstar$$\bigstar$$\bigstar$$\bigstar$.
...
\noindent Table~\ref{tab:ch5_governance_score} presents governance scoring matrix ($\bigstar$ 0--5), covering Governance pillar, Score, Runtime telemetry anchor and Next maturity step.
...
\noindent Table~\ref{tab:ch5_trust_score} presents trust scoring matrix ($\bigstar$ 0--5), covering Trust dimension, Score, Stakeholder and Combined evidence anchor.
...
\noindent Table~\ref{tab:ch5_customer_trust_pathway} presents customer (caregiver) trust pathway, covering Step, Customer state, Trust $\bigstar$ and Framework lever activated.
...
\noindent Table~\ref{tab:ch5_patient_consent_process} presents patient consent collection (consensus ai), covering Stage, Step, What happens and Evidence captured.
...
\noindent Table~\ref{tab:ch5_data_security_controls} presents data security \& encryption controls, covering Lifecycle stage, Control, Standard / Mechanism and $\bigstar$.
...
\noindent Table~\ref{tab:ch5_per_chapter_data_summary} presents per-chapter data-driven summary, covering Ch., Headline finding, Evidence base, and 2 more.
