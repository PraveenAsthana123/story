...
{\tablestripes\tablefontsize
\needspace{20\baselineskip}
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{3.0cm} p{8.2cm} >{\centering\arraybackslash}p{3.1cm} @{}}
...
{\tablestripes\tablefontsize
\needspace{20\baselineskip}
\begin{xltabular}{\textwidth}{@{} >{\centering\arraybackslash}p{1.0cm} >{\raggedright\arraybackslash}p{4.2cm} p{6.3cm} >{\centering\arraybackslash}p{1.0cm} >{\centering\arraybackslash}p{1.5cm} @{}}
