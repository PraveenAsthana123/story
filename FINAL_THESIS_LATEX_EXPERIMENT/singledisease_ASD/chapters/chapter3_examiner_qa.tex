...
\noindent Table~\ref{tab:examiner_qa_architecture} presents examiner q\&a on architecture, covering Q\#, Anticipated question + answer summary and Evidence pointers.
...
Q3 & \textbf{How does ISO 42001 satisfy EU AI Act requirements?} Answer: ISO 42001 §6.1.2 (risk assessment) + §7.5 (documented information) + §8.4 (process management) map directly to EU AI Act Articles 9 (risk management) + 12 (logging) + 13 (transparency) + 14 (human oversight). The audit-evidence runbook table cross-references each ISO clause to the EU AI Act article it satisfies. & Tables \ref{tab:per_phase_iso_42001}, \ref{tab:iso_audit_runbook} \\
