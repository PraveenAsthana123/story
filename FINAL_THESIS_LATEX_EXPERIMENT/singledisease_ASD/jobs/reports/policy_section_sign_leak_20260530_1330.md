# Policy Section-Sign (§) Leak Audit — 2026-05-30T13:30:01.307106
...
| File:Line | Context |
|---|---|
| `chapters/chapter5_discussion_recommendations.tex:1009` | `(per Hallucination Detection §): outputs with confidence $< 0.7$ are` |
