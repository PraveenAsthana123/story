...
Generated: 2026-05-30T00:53:16.242245
...
- **Build-log hbox horizontal-overflows**: 1219
- **squeezed_column**: 238 tables
- **empty_cells**: 83 tables
- **underused_column**: 50 tables
- **right_side_empty**: 45 tables
- **width_imbalanced**: 38 tables
- **multi_page**: 14 tables
- **tall_column**: 13 tables
...
| `appendices/D_ch4_supp_p390_w814.tex:1345` | `tab:ch4_alignment` | 4 | 3 | 2 | 53 | 14 | REBALANCE: last column avg 14 chars vs largest 53; narrow last column to p{1.5cm} or merge it with previous |
...
| `appendices/E_ch5_supp_p525_w1059.tex:1613` | `NOLABEL@appendices/E_ch5_supp_p525_w1059.tex:1613` | 8 | 2 | 16 | 1 | 1 | 2 | 41 | 6 | 1 | REBALANCE: last column avg 1 chars vs largest 41; narrow last column to p{1.5cm} or merge it with previous |
| `appendices/F_survey_instrument_p566_w1285.tex:1126` | `tab:survey_b2c_primary_addendum` | 3 | 4 | 85 | 11 | REBALANCE: last column avg 11 chars vs largest 85; narrow last column to p{1.5cm} or merge it with previous | WIDTH GAP: widths [1.0, 9.0, 3.2] differ by > 8x; use equal-space strategy |
| `appendices/F_survey_instrument_p566_w1285.tex:1290` | `tab:survey_analysis_full` | 4 | 1 | 22 | 79 | 19 | REBALANCE: last column avg 19 chars vs largest 79; narrow last column to p{1.5cm} or merge it with previous |
...
| `chapters/chapter5_discussion_recommendations.tex:6363` | `tab:secondary_data_stack` | 3 | 1.0 | 9.5 | 1.5 | WIDTH GAP: widths [1.0, 9.5, 1.5] differ by > 8x; use equal-space strategy |
...
| `appendices/M_operationalization_detail_p725.tex:502` | `tab:research_objectives` | 3 | 1.0 | 9.5 | 1.5 | WIDTH GAP: widths [1.0, 9.5, 1.5] differ by > 8x; use equal-space strategy |
...
| `chapters/chapter1_introduction.tex:3357` | `tab:backend_db` | 4 | 1.0 | 1.0 | 9.1 | 1.5 | WIDTH GAP: widths [1.0, 1.0, 9.1, 1.5] differ by > 8x; use equal-space strategy |
...
| `chapters/chapter3_research_methods.tex:1476` | `tab:primary_data_outcome_map` | 3 | 3.1 | 8.6 | 1.5 | WIDTH GAP: widths [3.1, 8.6, 1.5] differ by > 8x; use equal-space strategy |
...
| `appendices/J_human_centered_ecosystem_p680.tex:163` | `tab:appj_accessibility` | 3 | 3.6 | 8.1 | 1.5 | WIDTH GAP: widths [3.6, 8.1, 1.5] differ by > 8x; use equal-space strategy |
...
| `chapters/chapter1_introduction.tex:3094` | `tab:continuous_monitoring` | 4 | 1.0 | 2.7 | 7.4 | 1.5 | WIDTH GAP: widths [1.0, 2.7, 7.4, 1.5] differ by > 8x; use equal-space strategy |
| `chapters/chapter1_introduction.tex:2757` | `tab:b2c_user_forms` | 4 | 1.0 | 2.9 | 7.2 | 1.5 | WIDTH GAP: widths [1.0, 2.9, 7.2, 1.5] differ by > 8x; use equal-space strategy |
| `chapters/chapter1_introduction.tex:2944` | `tab:report_types` | 4 | 1.0 | 2.9 | 7.2 | 1.5 | WIDTH GAP: widths [1.0, 2.9, 7.2, 1.5] differ by > 8x; use equal-space strategy |
...
- **hbox horizontal-overflows**: 1219 cells exceed text-width
