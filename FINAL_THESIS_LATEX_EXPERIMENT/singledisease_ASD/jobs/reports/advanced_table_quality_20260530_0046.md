...
Generated: 2026-05-30T00:46:18.654328
...
| `chapters/chapter1_introduction.tex:620` | `tab:ch1_task_map` | 4 | 2 | 40 | 1 | 10 | REBALANCE: last column avg 10 chars vs largest 40; narrow last column to p{1.5cm} or merge it with previous | WIDTH GAP: widths [1.0, 7.1, 1.0, 3.5] differ by > 8x; use equal-space strategy |
...
| `chapters/chapter3_defence_prep_checklist.tex:18` | `tab:defence_prep_arch_checklist` | 4 | 2 | 49 | 1 | 15 | REBALANCE: last column avg 15 chars vs largest 49; narrow last column to p{1.5cm} or merge it with previous | WIDTH GAP: widths [1.0, 7.0, 1.0, 3.6] differ by > 8x; use equal-space strategy |
...
| `chapters/chapter4_analysis_findings.tex:774` | `tab:ch4_hybrid_findings_summary` | 4 | 3 | 63 | 115 | 9 | REBALANCE: last column avg 9 chars vs largest 115; narrow last column to p{1.5cm} or merge it with previous |
...
| `chapters/chapter4_analysis_findings.tex:5919` | `tab:ch4_partd_framework_quality` | 3 | 16 | 166 | 3 | REBALANCE: last column avg 3 chars vs largest 166; narrow last column to p{1.5cm} or merge it with previous |
...
| `appendices/F_survey_instrument_p566_w1285.tex:770` | `tab:survey_section_e_diag` | 7 | 2 | 207 | 2 | 1 | 1 | 1 | 2 | WIDEN COL 2 (max 207 chars) by NARROWING COL 4 (avg 1 chars) |
| `appendices/F_survey_instrument_p566_w1285.tex:737` | `tab:survey_section_d_reg` | 7 | 3 | 198 | 2 | 1 | 1 | 1 | 2 | WIDEN COL 2 (max 198 chars) by NARROWING COL 4 (avg 1 chars) |
| `appendices/F_survey_instrument_p566_w1285.tex:632` | `tab:survey_section_d_algo` | 7 | 2 | 191 | 2 | 1 | 1 | 1 | 2 | WIDEN COL 2 (max 191 chars) by NARROWING COL 4 (avg 1 chars) |
...
| `chapters/chapter3_research_methods.tex:2494` | `tab:primary_analysis_missing_data` | 4 | 36 | 172 | 62 | 38 | WIDEN COL 2 (max 172 chars) by NARROWING COL 1 (avg 24 chars) |
...
| `chapters/chapter3_research_methods.tex:4193` | `tab:ch3_reliability_validity` | 4 | 160 | 26 | 29 | 26 | WIDEN COL 1 (max 160 chars) by NARROWING COL 2 (avg 8 chars) |
...
| `appendices/M_operationalization_detail_p725.tex:635` | `tab:smart_objectives` | 6 | 3 | 119 | 120 | 66 | 60 | 22 | WIDEN COL 3 (max 120 chars) by NARROWING COL 1 (avg 2 chars) |
...
| `chapters/chapter3_examiner_qa.tex:17` | `tab:examiner_qa_architecture` | 3 | 1.0 | 8.6 | 3.6 | WIDTH GAP: widths [1.0, 8.6, 3.6] differ by > 8x; use equal-space strategy |
...
| `chapters/chapter1_introduction.tex:620` | `tab:ch1_task_map` | 4 | 1.0 | 7.1 | 1.0 | 3.5 | REBALANCE: last column avg 10 chars vs largest 40; narrow last column to p{1.5cm} or merge it with previous | WIDTH GAP: widths [1.0, 7.1, 1.0, 3.5] differ by > 8x; use equal-space strategy |
...
| `chapters/chapter3_defence_prep_checklist.tex:18` | `tab:defence_prep_arch_checklist` | 4 | 1.0 | 7.0 | 1.0 | 3.6 | REBALANCE: last column avg 15 chars vs largest 49; narrow last column to p{1.5cm} or merge it with previous | WIDTH GAP: widths [1.0, 7.0, 1.0, 3.6] differ by > 8x; use equal-space strategy |
